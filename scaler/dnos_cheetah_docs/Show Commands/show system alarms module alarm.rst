show system alarms module alarm
-------------------------------

**Minimum user role:** viewer

To display the system alarms that are currently active in the system filters by module name and alarm name:



**Command syntax: show system alarms module [module-name] alarm [alarm-name]** severity[severity-name] \| state[operator-state] \| severity[severity-name] state[operator-state]
...
::
    ...
    dnRouter# show system alarms module isis alarm isis_neighbor_adjacency_down
    ...
    dnRouter# show system alarms module isis alarm isis_neighbor_adjacency_down severity major
    ...
    dnRouter# show system alarms module isis alarm isis_neighbor_adjacency_down state ack
    ...
    dnRouter# show system alarms module isis alarm isis_neighbor_adjacency_down severity major state closed
