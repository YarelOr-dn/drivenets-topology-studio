...
+===============+======================================================================================================================================================================================+===========+===========================+
|               |                                                                                                                                                                                      |           |                           |
| interval      | The time (in seconds) that the PCE or PCC waits   after receiving a keep-alive message from its PCEP peer, before declaring the   peer dead.                                         | 0..255    | The TE PCEP dead-timer    |
|               |                                                                                                                                                                                      |           |                           |
...
::
	...
	dnRouter(cfg-te-pcep-pce)# no dead-timer
