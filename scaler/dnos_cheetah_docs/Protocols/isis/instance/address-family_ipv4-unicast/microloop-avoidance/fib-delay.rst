...
- Microloop avoidance fib-delay parameter is per ISIS topology. In the case of a single-topology, fib-delay of ipv4-unicast address-family will define the expected delay for ipv6 prefixes as well.
...
To revert fib-delay to default:
::
