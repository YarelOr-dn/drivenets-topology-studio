...
**Description:** Displays detailed information about packages in current, revert and target stacks relevant per each node in cluster. 
...
**Help line:** Displays detailed information about packages in current, revert and target stacks per each node in cluster
