...
Configure single dynamic NAPT44 N:1 rule
...
- any ip-address within external-ip-pool cannot duplicate with external-ip value of any static-nat44-rule

- any ip-address within external-ip-pool cannot duplicate with ip-address within external-ip-port value of any static-napt44-rule

- any ip-address within external-ip-pool cannot duplicate with external-ip value of any dynamic-napt44-rule
