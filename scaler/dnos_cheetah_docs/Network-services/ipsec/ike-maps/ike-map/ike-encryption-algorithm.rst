network-services ipsec ike-maps ike-map ike-encryption-algorithm
----------------------------------------------------------------
...
+==========================+==================================================================================+=================+=========+
| ike-encryption-algorithm | encryption algorithm type that are permitted for phase 1 of the IKE negotiations | | AES-256-GCM   | \-      |
|                          |                                                                                  | | AES-256-CBC   |         |
+--------------------------+----------------------------------------------------------------------------------+-----------------+---------+
...
::
    ...
    dnRouter(cfg-netsrv-ipsec-ikemaps)# ike-encryption-algorithm AES-128-CBC
...
::
    ...
    dnRouter(cfg-netsrv-ipsec-ikemaps)# no ike-encryption-algorithm
