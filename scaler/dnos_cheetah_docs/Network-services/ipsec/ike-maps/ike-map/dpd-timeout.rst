network-services ipsec ike-maps ike-map dpd-timeout
---------------------------------------------------
...
+=============+=============================+========+=========+
| dpd-timeout | dead peer detection timeout | 30-600 | \-      |
+-------------+-----------------------------+--------+---------+
...
::
    ...
    dnRouter(cfg-netsrv-ipsec-ikemaps)# dpd-timeout 30
...
::
    ...
    dnRouter(cfg-netsrv-ipsec-ikemaps)# no dpd-timeout
