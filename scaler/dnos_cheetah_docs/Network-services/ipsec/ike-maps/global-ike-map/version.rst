network-services ipsec ike-maps global-ike-map version
------------------------------------------------------
...
+===========+==============+===========+=========+
| version   | IKE version. | | ikev1   | ikev2   |
|           |              | | ikev2   |         |
+-----------+--------------+-----------+---------+
...
::
    ...
    dnRouter(cfg-netsrv-ipsec-glbl-ikemap)# version ikev2
...
::
    ...
    dnRouter(cfg-netsrv-ipsec-glbl-ikemap)# no version
