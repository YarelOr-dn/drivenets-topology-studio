# DNOS Segment-routing Configuration Reference

This document contains the complete DNOS CLI Segment-routing configuration syntax from the official DriveNets documentation.
...
**Command syntax: hop [hop-id] label [label]**
**Command syntax: hop [hop-id] include adjacency-sid [ip-address]**
**Command syntax: hop [hop-id] include prefix-sid index [index]**
**Command syntax: hop [hop-id] include prefix-sid ipv4-address [ipv4-address] {spf | strict-spf | [flex-algo id]}**
**Command syntax: hop [hop-id] include prefix-sid ipv6-address [ipv6-address] {spf | strict-spf | [flex-algo id]}**
