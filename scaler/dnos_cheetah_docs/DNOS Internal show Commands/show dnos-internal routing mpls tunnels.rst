show dnos-internal routing mpls tunnels
-----------------------------------------------

**Minimum user role:** viewer

To display the RIB MPLS-TE tunnel database:
...
::
	...
	dnRouter# show dnos-internal routing mpls tunnels
	...
	dnRouter# show dnos-internal routing mpls tunnels name core_mp1_1
	Tunnel database (size: 583):
	-------------------------------
	OID: 2, HEAD: core_mp1_1
	Destination: 100.0.0.1/32, In Label: ---, Nexthop: 50.170.0.0 via bundle-502, Out Label: 1002
	...
	dnRouter# show dnos-internal routing mpls tunnels destination 10.0.0.2
	Tunnel database (size: 583):
	-------------------------------
	OID: 3, HEAD: core_mp2_1
	Destination: 100.0.0.2/32, In Label: ---, Nexthop: 50.170.0.0 via bundle-502, Out Label: 1000
...
.. **Help line:** Displays RIB MPLS-TE tunnel database
