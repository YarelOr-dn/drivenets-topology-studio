...
**Device:** PE-1
**Mode:** execute
**Time:** 2026-04-16T16:24:33+00:00
**Overall:** FAIL
**Elapsed:** 436.3s

## Test Verdict: TEST_mac_mob_basic_SW205160 on PE-1
**Overall: FAIL** | Elapsed: 436.3s

| Scenario | Overall | Layers | Convergence | Debug Hint |
|----------|---------|--------|-------------|------------|
| SC01_learn_local_ac | PASS | trigger=PASS, control_plane=PASS, mac_flags=PASS, forwarding=PASS, ghost_macs=PASS, rt2_advertised=PASS, cross_layer=PASS, bgp_session=PASS, traces=SKIP, timing=PASS | 3.32s | -- |
| SC02_learn_remote_evpn | FAIL | trigger=PASS, control_plane=FAIL, mac_flags=FAIL, forwarding=FAIL, ghost_macs=PASS, cross_layer_mac_existence=FAIL, bgp_session=PASS, traces=PASS, timing=PASS | 44.54s | Layer 'control_plane' failed. 1 trace match(es) near 16:20 but no ERROR lines. | Action: Review trace lines for unexpected state transitions. |
| SC03_learn_vpls_pw | FAIL | trigger=PASS, control_plane=FAIL, mac_flags=FAIL, forwarding=FAIL, ghost_macs=PASS, cross_layer_mac_existence=FAIL, bgp_session=WARN, traces=PASS, timing=PASS | 27.53s | Layer 'control_plane' failed. 1 trace match(es) near 16:22 but no ERROR lines. | Action: Review trace lines for unexpected state transitions. |
| SC04_table_counts | WARN | scale=PASS, mac_flags=PASS, forwarding=PASS, ghost_macs=PASS, cross_layer=PASS, bgp_session=WARN, traces=SKIP, timing=PASS | 0.41s | -- |

### SC01_learn_local_ac: Learn MAC from local AC; expect Type-2 advertised

| Layer | Status | Detail | Time |
|-------|--------|--------|------|
| trigger | PASS | Learning 1 MACs on AC1 vlan 1000 (Q-in-Q outer=214) at 1Mbps (polled 0.254s) | 0.00s |
...
| timing | PASS | 3.32s <= 90.0s threshold | 0.00s |
...
| bgp_session | PASS | 1/3 ESTABLISHED | 0.25s |
| traces | PASS | No ERROR lines near 16:20 | 6.28s |
| timing | PASS | 44.54s <= 90.0s threshold | 0.00s |

**Debug:** Layer 'control_plane' failed. 1 trace match(es) near 16:20 but no ERROR lines. | Action: Review trace lines for unexpected state transitions.

### SC03_learn_vpls_pw: Learn MAC from VPLS PW (dynamic)

| Layer | Status | Detail | Time |
|-------|--------|--------|------|
| trigger | PASS | PW traffic via MPLS label 1032265 (outer=214, inner=3) | 0.00s |
...
| traces | PASS | No ERROR lines near 16:22 | 6.13s |
| timing | PASS | 27.53s <= 90.0s threshold | 0.00s |

**Debug:** Layer 'control_plane' failed. 1 trace match(es) near 16:22 but no ERROR lines. | Action: Review trace lines for unexpected state transitions.
...
| bgp_session | WARN | 0/3 ESTABLISHED (not required for this test) | 0.25s |
| traces | SKIP | Skipped trace check (infra failure detected) | 0.00s |
| timing | PASS | 0.41s <= 90.0s threshold | 0.00s |
