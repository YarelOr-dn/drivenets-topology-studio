...
**Run started:** 2026-05-01T13:45:03+00:00  |  **Primary DUT:** `PE-4`  |  **Dry run:** False  |  **Verdict:** **FAIL**

## Totals

- Total commands issued: **26**
- DNOS-rejected commands: **3**
- By method: `dnos_config_mcp`=26
...
_26 command(s) in this phase._

### 1. [2026-05-01T13:45:03.509+00:00] `PE-4` via `dnos_config_mcp` -- 50 ms
...
### 2. [2026-05-01T13:45:03.719+00:00] `PE-4` via `dnos_config_mcp` -- 205 ms
...
Routes over limit: 0
  ...
  2.2.2.2         4    1234567       4532       4622    0     0       0 3d00h54m                   0
  ...
  100.64.6.134    4      65200       4548       4668    0     0       0 00:51:54                   0
...
BGP table node count 3
  ...
  Neighbor        V         AS    MsgRcvd    MsgSent  InQ  OutQ  AdjOut  Up/Down   State/PfxAccepted
  2.2.2.2         4    1234567       4532       4622    0     0       2 3d00h54m                   3
  100.64.6.134    4      65200       4548       4668    0     0       5 00:51:54                   0
...
BGP table node count 50
  ...
  Neighbor        V         AS    MsgRcvd    MsgSent  InQ  OutQ  AdjOut  Up/Down   State/PfxAccepted
  2.2.2.2         4    1234567       4532       4622    0     0      14 3d00h54m                  12
...
BGP table node count 3
  ...
  Neighbor        V         AS    MsgRcvd    MsgSent  InQ  OutQ  AdjOut  Up/Down   State/PfxAccepted
  2.2.2.2         4    1234567       4532       4622    0     0       0 3d00h54m  (NoNeg)
  100.64.6.134    4      65200       4548       4668    0     0       0 00:51:54                   3
...
BGP table node count 2
  ...
  Neighbor        V         AS    MsgRcvd    MsgSent  InQ  OutQ  AdjOut  Up/Down   State/PfxAccepted
  2.2.2.2         4    1234567       4532       4622    0     0       2 3d00h54m                   1
  100.64.6.134    4      65200       4548       4668    0     0       0 00:51:54  (NoNeg)
...
... [truncated: 26 lines omitted; see execution_log.jsonl for full output] ...
  ...
  Neighbor        V         AS    MsgRcvd    MsgSent  InQ  OutQ  AdjOut  Up/Down   State/PfxAccepted
  2.2.2.2         4    1234567       4532       4622    0     0       3 3d00h54m                   5
...
BGP table node count 4
  ...
  Neighbor        V         AS    MsgRcvd    MsgSent  InQ  OutQ  AdjOut  Up/Down   State/PfxAccepted
  2.2.2.2         4    1234567       4532       4622    0     0       3 3d00h54m                   4
...
### 3. [2026-05-01T13:45:03.770+00:00] `PE-4` via `dnos_config_mcp` -- 50 ms
...
### 4. [2026-05-01T13:45:03.979+00:00] `PE-4` via `dnos_config_mcp` -- 205 ms
...
### 5. [2026-05-01T13:45:04.081+00:00] `PE-4` via `dnos_config_mcp` -- 100 ms
...
### 6. [2026-05-01T13:45:04.182+00:00] `PE-4` via `dnos_config_mcp` -- 100 ms
...
Interface lo0
	...
	Admin state: enabled, Operational state: up, Uptime: 4 days, 5:04:47
	Description: 
	MAC Address: N/A
...
### 7. [2026-05-01T13:45:04.336+00:00] `PE-4` via `dnos_config_mcp` -- 152 ms
...
### 8. [2026-05-01T13:45:04.441+00:00] `PE-4` via `dnos_config_mcp` -- 102 ms
...
EVPN: EVPN_SI_VPLS_1
  ...
  +-------------------------+--------------------------------------------------------------+---------------------+-----------------------------+---------------------------------+----------------+
  | ge100-18/0/1            | up / forwarding-all                                          | 2 days, 0:20:55     | single-homed                |                                 | 1              |
...
### 9. [2026-05-01T13:45:04.544+00:00] `PE-4` via `dnos_config_mcp` -- 102 ms
...
### 10. [2026-05-01T13:45:04.746+00:00] `PE-4` via `dnos_config_mcp` -- 200 ms
...
### 11. [2026-05-01T13:45:04.847+00:00] `PE-4` via `dnos_config_mcp` -- 100 ms
...
### 12. [2026-05-01T13:45:23.671+00:00] `PE-4` via `dnos_config_mcp` -- 201 ms
...
BGP table node count 4
  ...
  Neighbor        V         AS    MsgRcvd    MsgSent  InQ  OutQ  AdjOut  Up/Down   State/PfxAccepted
  2.2.2.2         4    1234567       4533       4624    0     0       2 3d00h54m                   4
...
### 13. [2026-05-01T13:45:32.402+00:00] `PE-4` via `dnos_config_mcp` -- 201 ms
...
### 14. [2026-05-01T13:45:33.604+00:00] `PE-4` via `dnos_config_mcp` -- 200 ms
...
### 15. [2026-05-01T13:45:34.806+00:00] `PE-4` via `dnos_config_mcp` -- 200 ms
...
### 16. [2026-05-01T13:45:36.008+00:00] `PE-4` via `dnos_config_mcp` -- 200 ms
...
### 17. [2026-05-01T13:45:37.210+00:00] `PE-4` via `dnos_config_mcp` -- 200 ms
...
### 18. [2026-05-01T13:45:38.412+00:00] `PE-4` via `dnos_config_mcp` -- 200 ms
...
### 19. [2026-05-01T13:45:39.614+00:00] `PE-4` via `dnos_config_mcp` -- 200 ms
...
### 20. [2026-05-01T13:45:40.815+00:00] `PE-4` via `dnos_config_mcp` -- 200 ms
...
### 21. [2026-05-01T13:45:42.017+00:00] `PE-4` via `dnos_config_mcp` -- 200 ms
...
### 22. [2026-05-01T13:45:42.401+00:00] `PE-4` via `dnos_config_mcp` -- 200 ms
...
### 23. [2026-05-01T13:45:46.719+00:00] `PE-4` via `dnos_config_mcp` -- 50 ms
...
### 24. [2026-05-01T13:45:46.822+00:00] `PE-4` via `dnos_config_mcp` -- 100 ms **REJECTED**
...
### 25. [2026-05-01T13:45:46.923+00:00] `PE-4` via `dnos_config_mcp` -- 100 ms **REJECTED**
...
### 26. [2026-05-01T13:45:47.024+00:00] `PE-4` via `dnos_config_mcp` -- 100 ms **REJECTED**
