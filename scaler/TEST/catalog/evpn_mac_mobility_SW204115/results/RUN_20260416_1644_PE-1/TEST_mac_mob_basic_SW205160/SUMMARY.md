...
**Device:** PE-1
**Mode:** plan
**Time:** 2026-04-16T16:44:29+00:00
...
```json
{
  ...
  "runtime_params": {
    ...
    "pw_peer_ip": "6.6.6.6",
    "pw_remote_site_id": "3",
    "pw_ingress_label": "1032265",
    "pw_local_site_id": "2",
    "pw_egress_label": "17",
    "pw_source_instance": "PW_TEST_ELAN",
    ...
    "scenarios": [
      {
        ...
        "expanded_commands": [
          {
            "phase": "snapshot",
            "cmd": "show evpn mac-table instance HA_TEST_ELAN | no-more"
          },
          {
            "phase": "snapshot",
        ...
        "trigger_plan": {
          "scenario_id": "SC01_learn_local_ac",
          "from": "traffic_on_ac1",
          "to": "learn_on_ac1",
          ...
          "operator_steps": [
            {
              ...
              "detail": "Verify 1 MAC(s) learned on traffic_on_ac1"
            },
            {
              "action": "shift_traffic",
              "detail": "Move traffic so same MAC(s) appear on learn_on_ac1"
            },
            {
              "action": "verify_move",
          ...
          "spirent_strategy": "Create L2 device blocks with same MAC pool on VLANs mapped to traffic_on_ac1 and learn_on_ac1. Start traffic on traffic_on_ac1 VLAN to learn, stop, start on learn_on_ac1 VLAN to trigger move.",
      ...
      },
      {
        ...
        "trigger_plan": {
          "scenario_id": "SC02_learn_remote_evpn",
          "from": "remote_pe_traffic",
          "to": "spirent_remote_pe",
          "primary_method": "spirent",
          "available_methods": [
            "spirent",
            "manual"
          ...
          "operator_steps": [
            {
              "action": "ensure_learned",
              "detail": "Verify 1 MAC(s) learned on remote_pe_traffic"
            },
            {
              "action": "shift_traffic",
              "detail": "Move traffic so same MAC(s) appear on spirent_remote_pe"
            },
            {
              "action": "verify_move",
              "detail": "show evpn mac-table instance {evpn_name} mac {test_mac} | no-more"
          ...
          "spirent_strategy": "Create L2 device blocks with same MAC pool on VLANs mapped to remote_pe_traffic and spirent_remote_pe. Start traffic on remote_pe_traffic VLAN to learn, stop, start on spirent_remote_pe VLAN to trigger move.",
          "scale_note": "For 64K MACs: spirent_tool.py create-device --device-count 65536 --mac-step 1. One REST call via STC Device Block multiplier (~5s)."
        }
      },
      {
        ...
        "trigger_plan": {
          "scenario_id": "SC03_learn_vpls_pw",
          "from": "traffic_via_pw",
          "to": "spirent_pw_traffic",
          "primary_method": "spirent",
          "available_methods": [
            "spirent",
            "manual"
          ...
          "operator_steps": [
            {
              "action": "ensure_learned",
              "detail": "Verify 1 MAC(s) learned on traffic_via_pw"
            },
            {
              "action": "shift_traffic",
              "detail": "Move traffic so same MAC(s) appear on spirent_pw_traffic"
            },
            {
              "action": "verify_move",
              "detail": "show evpn mac-table instance {evpn_name} mac {test_mac} | no-more"
          ...
          "spirent_strategy": "Create L2 device blocks with same MAC pool on VLANs mapped to traffic_via_pw and spirent_pw_traffic. Start traffic on traffic_via_pw VLAN to learn, stop, start on spirent_pw_traffic VLAN to trigger move.",
          "scale_note": "For 64K MACs: spirent_tool.py create-device --device-count 65536 --mac-step 1. One REST call via STC Device Block multiplier (~5s)."
        }
      },
      {
        ...
        "expanded_commands": [
          ...
          {
            "phase": "verify",
            "cmd": "show evpn summary | no-more"
          },
          {
            "phase": "verify",
            "cmd": "show bridge-domain instance | no-more"
          }
        ],
        "trigger_plan": null
      }
