# TEST_mac_mob_clear_ops_G5

**Device:** PE-1
**Mode:** dry-run
**Time:** 2026-04-20T07:47:06+00:00

```json
{
  "prerequisites": {
    "test_id": "TEST_mac_mob_clear_ops_G5",
    "device": "PE-1",
    "rows": [
      {
        "check": "evpn_instance",
  ...
  "dry_plan": {
    "id": "TEST_mac_mob_clear_ops_G5",
    "scenarios": [
      {
        "id": "SC01_clear_mac_suppression_all",
        "expanded_commands": [
          {
            "phase": "snapshot",
          ...
          {
            "phase": "verify",
            "cmd": "show dnos-internal routing evpn instance HA_TEST_ELAN mac-table-ghost detail | no-more"
          }
        ],
        "trigger_plan": {
          "scenario_id": "SC01_clear_mac_suppression_all",
          "from": "clear_with_assertion",
          "to": "clear_assert_state",
          ...
          "operator_steps": [
            {
              ...
              "detail": "Verify 1 MAC(s) learned on clear_with_assertion"
            },
            {
              "action": "shift_traffic",
              "detail": "Move traffic so same MAC(s) appear on clear_assert_state"
            },
            {
              "action": "verify_move",
          ...
          "spirent_strategy": "Create L2 device blocks with same MAC pool on VLANs mapped to clear_with_assertion and clear_assert_state. Start traffic on clear_with_assertion VLAN to learn, stop, start on clear_assert_state VLAN to trigger move.",
      ...
      {
        "id": "SC02_clear_mac_suppression_single",
        "expanded_commands": [],
        "trigger_plan": {
          "scenario_id": "SC02_clear_mac_suppression_single",
          "from": "clear_with_assertion",
          "to": "clear_assert_state",
          "primary_method": "spirent",
          "available_methods": [
      ...
      },
      {
        ...
        "trigger_plan": {
          "scenario_id": "SC03_clear_mac_history",
          "from": "clear_with_assertion",
          "to": "clear_assert_state",
          "primary_method": "spirent",
          "available_methods": [
      ...
      {
        "id": "SC04_clear_restore_cycles",
        "expanded_commands": [],
        "trigger_plan": {
          "scenario_id": "SC04_clear_restore_cycles",
          "from": "clear_with_assertion",
          "to": "clear_assert_state",
          "primary_method": "spirent",
          "available_methods": [
  ...
  "live_validation": [
    ...
    },
    {
      ...
      "was_unvalidated": "False",
      "status": "VALID",
      "output_preview": "# YOR_PE-1 config-start [20-Apr-2026 10:47:06 UTC+03:00 (Israel)]\n\nnetwork-services\n  evpn\n    instance HA_TEST_ELAN\n      mac-handling\n        loop-prevention\n          admin-state enabled\n          "
    }
  ]
}
```