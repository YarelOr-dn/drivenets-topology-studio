# TEST_mac_mob_pw_suppress_G4

**Device:** PE-1
**Mode:** dry-run
**Time:** 2026-04-20T07:47:25+00:00

```json
{
  "prerequisites": {
    "test_id": "TEST_mac_mob_pw_suppress_G4",
    "device": "PE-1",
    "rows": [
      {
        "check": "evpn_instance",
  ...
  "dry_plan": {
    "id": "TEST_mac_mob_pw_suppress_G4",
    "scenarios": [
      {
        "id": "SC01_cross_domain_blackhole_sanction",
        "expanded_commands": [
          {
            "phase": "verify",
          ...
          {
            "phase": "verify",
            "cmd": "show evpn instance HA_TEST_ELAN loop-prevention mac-table | no-more"
          },
          {
            "phase": "verify",
        ...
        "trigger_plan": {
          "scenario_id": "SC01_cross_domain_blackhole_sanction",
          "from": "rapid_ac_evpn_flap",
          "to": "cross_domain_sanction_assert",
          ...
          "operator_steps": [
            {
              ...
              "detail": "Verify 1 MAC(s) learned on rapid_ac_evpn_flap"
            },
            {
              "action": "shift_traffic",
              "detail": "Move traffic so same MAC(s) appear on cross_domain_sanction_assert"
            },
            {
              "action": "verify_move",
          ...
          "spirent_strategy": "Create L2 device blocks with same MAC pool on VLANs mapped to rapid_ac_evpn_flap and cross_domain_sanction_assert. Start traffic on rapid_ac_evpn_flap VLAN to learn, stop, start on cross_domain_sanction_assert VLAN to trigger move.",
      ...
      {
        "id": "SC02_cross_domain_shutdown_sanction",
        "expanded_commands": [
          {
            "phase": "verify",
            "cmd": "show evpn instance HA_TEST_ELAN loop-prevention interface | no-more"
          },
          {
            "phase": "verify",
            "cmd": "show evpn mac-table instance HA_TEST_ELAN suppress | no-more"
        ...
        "trigger_plan": {
          "scenario_id": "SC02_cross_domain_shutdown_sanction",
          "from": "rapid_ac_evpn_flap",
          "to": "cross_domain_sanction_assert",
          "primary_method": "spirent",
          "available_methods": [
      ...
      {
        "id": "SC03_suppress_sanction_cross_domain",
        "expanded_commands": [
          {
            "phase": "verify",
            "cmd": "show evpn instance HA_TEST_ELAN loop-prevention mac-table | no-more"
        ...
        "trigger_plan": {
          "scenario_id": "SC03_suppress_sanction_cross_domain",
          "from": "rapid_ac_evpn_flap",
          "to": "cross_domain_sanction_assert",
          "primary_method": "spirent",
          "available_methods": [
      ...
      {
        "id": "SC04_remote_remote_no_suppression",
        "expanded_commands": [
          {
            "phase": "verify",
            "cmd": "show evpn mac-table instance HA_TEST_ELAN suppress | no-more"
        ...
        "trigger_plan": {
          "scenario_id": "SC04_remote_remote_no_suppression",
          "from": "rapid_remote_seq_updates",
          "to": "cross_domain_sanction_assert",
          "primary_method": "spirent",
          "available_methods": [
            "spirent",
          ...
          "operator_steps": [
            {
              "action": "ensure_learned",
              "detail": "Verify 1 MAC(s) learned on rapid_remote_seq_updates"
            },
            {
              "action": "shift_traffic",
              "detail": "Move traffic so same MAC(s) appear on cross_domain_sanction_assert"
          ...
          "spirent_strategy": "Create L2 device blocks with same MAC pool on VLANs mapped to rapid_remote_seq_updates and cross_domain_sanction_assert. Start traffic on rapid_remote_seq_updates VLAN to learn, stop, start on cross_domain_sanction_assert VLAN to trigger move.",
          "scale_note": "For 64K MACs: spirent_tool.py create-device --device-count 65536 --mac-step 1. One REST call via STC Device Block multiplier (~5s)."
        }
      }
    ]
  ...
  "live_validation": [
    ...
    {
      "prereq_id": "ac",
      "command": "show evpn instance HA_TEST_ELAN detail | no-more",
      "was_unvalidated": "False",
      "status": "VALID",
      "output_preview": "EVPN: HA_TEST_ELAN\n  EVI ID : 1\n  Route Distinguisher            : 1.1.1.1:500\n  Transport protocol             : mpls\n  Fat label                      : disabled\n  Control word                   : en"
    },
    {
      "prereq_id": "spirent_evpn_peer",
      "command": "spirent_tool.py bgp-status --json",
      "status": "SKIPPED",
    ...
    },
    {
      ...
      "was_unvalidated": "False",
      "status": "VALID",
      "output_preview": "# YOR_PE-1 config-start [20-Apr-2026 10:47:25 UTC+03:00 (Israel)]\n\nnetwork-services\n  evpn\n    instance HA_TEST_ELAN\n      mac-handling\n        loop-prevention\n          admin-state enabled\n          "
    }
  ]
}
```