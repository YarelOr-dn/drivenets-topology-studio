...
**Device:** PE-1
**Mode:** execute
**Time:** 2026-04-16T15:29:35+00:00
**Overall:** FAIL
**Elapsed:** 320.6s

## Test Verdict: TEST_mac_mob_basic_SW205160 on PE-1
**Overall: FAIL** | Elapsed: 320.6s

| Scenario | Overall | Layers | Convergence | Debug Hint |
|----------|---------|--------|-------------|------------|
| SC01_learn_local_ac | WARN | trigger=PASS, control_plane=PASS, mac_flags=PASS, forwarding=PASS, ghost_macs=PASS, rt2_advertised=PASS, cross_layer=PASS, bgp_session=WARN, traces=SKIP, timing=PASS | 7.98s | -- |
| SC02_learn_remote_evpn | FAIL | trigger=FAIL | -- | -- |
| SC03_learn_vpls_pw | FAIL | trigger=PASS, control_plane=FAIL, mac_flags=FAIL, forwarding=FAIL, ghost_macs=PASS, cross_layer_mac_existence=FAIL, bgp_session=WARN, traces=PASS, timing=PASS | 38.02s | Layer 'control_plane' failed. No trace hits near 15:27. Trace buffer may have rotated or timestamp mismatch. | Action: Reproduce the failure for fresh traces. Check trace buffer size: show file traces routing_engine/bgpd_traces | tail 5 |
...
| timing | PASS | 7.98s <= 90.0s threshold | 0.00s |
...
| Layer | Status | Detail | Time |
|-------|--------|--------|------|
| trigger | PASS | PW traffic via MPLS label 1032265 (inner=0) | 0.00s |
...
| bgp_session | WARN | 0/3 ESTABLISHED (not required for this test) | 0.25s |
| traces | PASS | No ERROR lines near 15:27 | 5.50s |
| timing | PASS | 38.02s <= 90.0s threshold | 0.00s |

**Debug:** Layer 'control_plane' failed. No trace hits near 15:27. Trace buffer may have rotated or timestamp mismatch. | Action: Reproduce the failure for fresh traces. Check trace buffer size: show file traces routing_engine/bgpd_traces | tail 5
