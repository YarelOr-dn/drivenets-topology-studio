...
**Device:** PE-1
**Mode:** execute
**Time:** 2026-04-14T17:32:09+00:00
**Overall:** FAIL
**Elapsed:** 276.0s

## Test Verdict: TEST_mac_mob_basic_SW205160 on PE-1
**Overall: FAIL** | Elapsed: 276.0s

| Scenario | Overall | Layers | Convergence | Debug Hint |
|----------|---------|--------|-------------|------------|
| SC03_learn_vpls_pw | SKIP | prereq_gate=SKIP | -- | -- |
| SC01_learn_local_ac | PASS | trigger=PASS, control_plane=PASS, mac_flags=PASS, forwarding=PASS, ghost_macs=PASS, rt2_advertised=PASS, cross_layer=PASS, bgp_session=PASS, traces=SKIP, timing=PASS | 2.08s | -- |
| SC02_learn_remote_evpn | FAIL | trigger=PASS, control_plane=FAIL, mac_flags=FAIL, forwarding=FAIL, ghost_macs=PASS, cross_layer_mac_existence=FAIL, bgp_session=PASS, traces=PASS, timing=PASS | 44.56s | Layer 'control_plane' failed. No trace hits near 17:28. Trace buffer may have rotated or timestamp mismatch. | Action: Reproduce the failure for fresh traces. Check trace buffer size: show file traces routing_engine/bgpd_traces | tail 5 |
...
| forwarding | PASS | NCP state: forwarding (expected forwarding) | 0.30s |
...
| timing | PASS | 2.08s <= 90.0s threshold | 0.00s |
...
| bgp_session | PASS | 1/3 ESTABLISHED | 0.25s |
| traces | PASS | No ERROR lines near 17:28 | 12.53s |
| timing | PASS | 44.56s <= 90.0s threshold | 0.00s |

**Debug:** Layer 'control_plane' failed. No trace hits near 17:28. Trace buffer may have rotated or timestamp mismatch. | Action: Reproduce the failure for fresh traces. Check trace buffer size: show file traces routing_engine/bgpd_traces | tail 5
