...
**Device:** PE-1
**Mode:** execute
**Time:** 2026-04-14T18:15:03+00:00
**Overall:** FAIL
**Elapsed:** 519.4s

## Test Verdict: TEST_mac_mob_basic_SW205160 on PE-1
**Overall: FAIL** | Elapsed: 519.4s

| Scenario | Overall | Layers | Convergence | Debug Hint |
|----------|---------|--------|-------------|------------|
| SC01_learn_local_ac | WARN | trigger=PASS, control_plane=PASS, mac_flags=PASS, forwarding=PASS, ghost_macs=PASS, rt2_advertised=PASS, cross_layer=PASS, bgp_session=WARN, traces=SKIP, timing=PASS | 2.20s | -- |
| SC02_learn_remote_evpn | PASS | trigger=PASS, control_plane=PASS, mac_flags=PASS, forwarding=PASS, ghost_macs=PASS, cross_layer=PASS, bgp_session=PASS, traces=SKIP, timing=PASS | 14.81s | -- |
| SC03_learn_vpls_pw | FAIL | trigger=SKIP, control_plane=FAIL, mac_flags=FAIL, forwarding=FAIL, ghost_macs=PASS, cross_layer_mac_existence=FAIL, bgp_session=PASS, traces=PASS, timing=WARN | 116.61s | Layer 'control_plane' failed. 1 trace match(es) near 18:10 but no ERROR lines. | Action: Review trace lines for unexpected state transitions. |
| SC04_table_counts | FAIL | scale=PASS, mac_flags=FAIL, forwarding=FAIL, ghost_macs=PASS, cross_layer_mac_existence=FAIL, bgp_session=PASS, traces=PASS, timing=PASS | 0.55s | Layer 'mac_flags' failed. 1 trace match(es) near 18:13 but no ERROR lines. | Action: Review trace lines for unexpected state transitions. |
...
| timing | PASS | 2.20s <= 90.0s threshold | 0.00s |
...
| traces | SKIP | Skipped trace check (infra failure detected) | 0.00s |
| timing | PASS | 14.81s <= 90.0s threshold | 0.00s |
...
| bgp_session | PASS | 1/3 ESTABLISHED | 0.25s |
| traces | PASS | No ERROR lines near 18:10 | 12.80s |
| timing | WARN | 116.61s > 90.0s (within 2x) | 0.00s |

**Debug:** Layer 'control_plane' failed. 1 trace match(es) near 18:10 but no ERROR lines. | Action: Review trace lines for unexpected state transitions.
...
| forwarding | FAIL | MAC not found in forwarding table | 0.10s |
| ghost_macs | PASS | No stale/ghost MACs | 0.25s |
| cross_layer_mac_existence | FAIL | MAC 00:de:ad:ff:ff:01 not found in mac-table | 0.00s |
| bgp_session | PASS | 1/3 ESTABLISHED | 0.25s |
| traces | PASS | No ERROR lines near 18:13 | 12.66s |
| timing | PASS | 0.55s <= 90.0s threshold | 0.00s |

**Debug:** Layer 'mac_flags' failed. 1 trace match(es) near 18:13 but no ERROR lines. | Action: Review trace lines for unexpected state transitions.
