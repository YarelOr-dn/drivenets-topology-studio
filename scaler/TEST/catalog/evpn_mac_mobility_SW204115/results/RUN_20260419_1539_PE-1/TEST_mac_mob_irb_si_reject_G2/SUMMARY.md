...
**Device:** PE-1
**Mode:** dry-run
**Time:** 2026-04-19T15:39:56+00:00

```json
{
  "prerequisites": {
    "test_id": "TEST_mac_mob_irb_si_reject_G2",
    "device": "PE-1",
    "rows": [
      {
        "check": "evpn_instance",
  ...
  "dry_plan": {
    "id": "TEST_mac_mob_irb_si_reject_G2",
    "scenarios": [
      {
        "id": "SC01_add_irb_to_si_instance",
        "expanded_commands": [
          {
            "phase": "snapshot",
            "cmd": "show config network-services evpn instance {si_instance_name} | no-more"
          },
          {
            "phase": "verify",
            "cmd": "show config network-services evpn instance {si_instance_name} | no-more"
        ...
        "trigger_plan": {
          "scenario_id": "SC01_add_irb_to_si_instance",
          "from": "attempt_irb_config",
          "to": "commit_check_assert",
          ...
          "operator_steps": [
            {
              ...
              "detail": "Verify 1 MAC(s) learned on attempt_irb_config"
            },
            {
              "action": "shift_traffic",
              "detail": "Move traffic so same MAC(s) appear on commit_check_assert"
            },
            {
              "action": "verify_move",
          ...
          "spirent_strategy": "Create L2 device blocks with same MAC pool on VLANs mapped to attempt_irb_config and commit_check_assert. Start traffic on attempt_irb_config VLAN to learn, stop, start on commit_check_assert VLAN to trigger move.",
      ...
      {
        "id": "SC02_add_si_to_irb_instance",
        "expanded_commands": [],
        "trigger_plan": {
          "scenario_id": "SC02_add_si_to_irb_instance",
          "from": "create_irb_instance_then_add_si",
          "to": "commit_check_assert",
          "primary_method": "spirent",
          "available_methods": [
            "spirent",
          ...
          "operator_steps": [
            {
              "action": "ensure_learned",
              "detail": "Verify 1 MAC(s) learned on create_irb_instance_then_add_si"
            },
            {
              "action": "shift_traffic",
              "detail": "Move traffic so same MAC(s) appear on commit_check_assert"
          ...
          "spirent_strategy": "Create L2 device blocks with same MAC pool on VLANs mapped to create_irb_instance_then_add_si and commit_check_assert. Start traffic on create_irb_instance_then_add_si VLAN to learn, stop, start on commit_check_assert VLAN to trigger move.",
          "scale_note": "For 64K MACs: spirent_tool.py create-device --device-count 65536 --mac-step 1. One REST call via STC Device Block multiplier (~5s)."
        }
      },
      {
        "id": "SC03_remove_si_add_irb_success",
        "expanded_commands": [],
        "trigger_plan": {
          "scenario_id": "SC03_remove_si_add_irb_success",
          "from": "remove_si_add_irb",
          "to": "commit_check_assert",
          "primary_method": "spirent",
          "available_methods": [
            "spirent",
          ...
          "operator_steps": [
            {
              "action": "ensure_learned",
              "detail": "Verify 1 MAC(s) learned on remove_si_add_irb"
            },
            {
              "action": "shift_traffic",
              "detail": "Move traffic so same MAC(s) appear on commit_check_assert"
          ...
          "spirent_strategy": "Create L2 device blocks with same MAC pool on VLANs mapped to remove_si_add_irb and commit_check_assert. Start traffic on remove_si_add_irb VLAN to learn, stop, start on commit_check_assert VLAN to trigger move.",
          "scale_note": "For 64K MACs: spirent_tool.py create-device --device-count 65536 --mac-step 1. One REST call via STC Device Block multiplier (~5s)."
        }
      }
    ]
  ...
  "live_validation": [
    {
      "prereq_id": "evpn_instance_with_si",
      "command": "show config network-services evpn | no-more",
      "was_unvalidated": "False",
      "status": "VALID",
      "output_preview": "# YOR_PE-1 config-start [19-Apr-2026 18:39:56 UTC+03:00 (Israel)]\n\nnetwork-services\n  evpn\n    instance HA_TEST_ELAN\n      protocols\n        bgp 1234567\n          export-l2vpn-evpn route-target 100:10"
    },
    {
      "prereq_id": "evpn_instance_without_si",
      "command": "show config network-services evpn | no-more",
      "was_unvalidated": "False",
      "status": "VALID",
      "output_preview": "# YOR_PE-1 config-start [19-Apr-2026 18:39:56 UTC+03:00 (Israel)]\n\nnetwork-services\n  evpn\n    instance HA_TEST_ELAN\n      protocols\n        bgp 1234567\n          export-l2vpn-evpn route-target 100:10"
