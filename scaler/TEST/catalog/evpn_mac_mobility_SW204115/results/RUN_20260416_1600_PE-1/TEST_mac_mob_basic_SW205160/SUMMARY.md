...
**Device:** PE-1
**Mode:** execute
**Time:** 2026-04-16T16:04:36+00:00
**Overall:** FAIL
**Elapsed:** 264.8s

## Test Verdict: TEST_mac_mob_basic_SW205160 on PE-1
**Overall: FAIL** | Elapsed: 264.8s

| Scenario | Overall | Layers | Convergence | Debug Hint |
|----------|---------|--------|-------------|------------|
| SC01_learn_local_ac | WARN | trigger=PASS, control_plane=PASS, mac_flags=PASS, forwarding=PASS, ghost_macs=PASS, rt2_advertised=PASS, cross_layer=PASS, bgp_session=WARN, traces=SKIP, timing=PASS | 2.38s | -- |
| SC02_learn_remote_evpn | PASS | trigger=PASS, control_plane=PASS, mac_flags=PASS, forwarding=PASS, ghost_macs=PASS, cross_layer=PASS, bgp_session=PASS, traces=SKIP, timing=PASS | 14.24s | -- |
| SC03_learn_vpls_pw | FAIL | trigger=PASS, control_plane=FAIL, mac_flags=FAIL, forwarding=FAIL, ghost_macs=PASS, cross_layer_mac_existence=FAIL, bgp_session=PASS, traces=PASS, timing=PASS | 27.24s | Layer 'control_plane' failed. No trace hits near 16:02. Trace buffer may have rotated or timestamp mismatch. | Action: Reproduce the failure for fresh traces. Check trace buffer size: show file traces routing_engine/bgpd_traces | tail 5 |
...
| timing | PASS | 2.38s <= 90.0s threshold | 0.00s |
...
| traces | SKIP | Skipped trace check (infra failure detected) | 0.00s |
| timing | PASS | 14.24s <= 90.0s threshold | 0.00s |
...
| bgp_session | PASS | 1/3 ESTABLISHED | 0.25s |
| traces | PASS | No ERROR lines near 16:02 | 5.53s |
| timing | PASS | 27.24s <= 90.0s threshold | 0.00s |

**Debug:** Layer 'control_plane' failed. No trace hits near 16:02. Trace buffer may have rotated or timestamp mismatch. | Action: Reproduce the failure for fresh traces. Check trace buffer size: show file traces routing_engine/bgpd_traces | tail 5
