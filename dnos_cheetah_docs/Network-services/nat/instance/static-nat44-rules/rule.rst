...
Configure the single static NAT44 1:1 rule.
...
- The external-ip cannot duplicate with the ip-address within the external-ip-port value of the any static-napt44-rule.

- The external-ip cannot duplicate with the external-ip value of the any dynamic-napt44-rule.

- The external-ip cannot duplicate with the any address in the external-ip-pool of the any dyanamic-nat44-rule.
