network-services ipsec peer-authentication digital-signature ca-data
--------------------------------------------------------------------
...
The ca-data list represents the certificate's authorities trusted by the system.
...
2. Configure the certificate as trusted in the ca-data list:
