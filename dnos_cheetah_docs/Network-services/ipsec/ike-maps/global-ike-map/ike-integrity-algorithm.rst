network-services ipsec ike-maps global-ike-map ike-integrity-algorithm
----------------------------------------------------------------------
...
+=========================+=================================================================================+==========+==========+
| ike-integrity-algorithm | integrity algorithm type that are permitted for phase 1 of the IKE negotiations | SHA2-256 | SHA2-256 |
+-------------------------+---------------------------------------------------------------------------------+----------+----------+
...
::
    ...
    dnRouter(cfg-netsrv-ipsec-glbl-ikemap)# ike-integrity-algorithm AES-128-CBC
...
::
    ...
    dnRouter(cfg-netsrv-ipsec-glbl-ikemap)# no ike-integrity-algorithm
