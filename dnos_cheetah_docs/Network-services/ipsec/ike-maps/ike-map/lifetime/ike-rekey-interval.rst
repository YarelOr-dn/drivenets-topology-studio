network-services ipsec ike-maps ike-map lifetime ike-rekey-interval
-------------------------------------------------------------------
...
::
    ...
    dnRouter(cfg-netsrv-ipsec-ikemaps-life)# ike-rekey-interval 14400
...
::
    ...
    dnRouter(cfg-netsrv-ipsec-ikemaps-life)# no ike-rekey-interval
