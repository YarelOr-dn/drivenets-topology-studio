vrf protocols bgp address-family export-vpn route-target
--------------------------------------------------------

**Command syntax: export-vpn route-target [route-target],** [route-target], .

**Description:** Enable export of routes with route-target tag
...
can export multiple different route-target tagged routes.

route-target can be different from the vrf route-distinguisher

no command stops exporting routes

**Help line:** Enable export of routes with route-target tag
