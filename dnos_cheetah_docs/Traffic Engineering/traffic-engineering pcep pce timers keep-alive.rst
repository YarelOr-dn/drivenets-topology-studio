traffic-engineering pcep pce timers keep-alive
----------------------------------------------
...
+===============+============================================================================================================================================================================================+===========+=================================+
|               |                                                                                                                                                                                            |           |                                 |
| interval      | The time (in seconds) that the PCE or PCC waits   after sending a keep-alive message to its PCEP peer, before sending another   keep-alive message notifying the peer of its availability. | 0..255    | The TE PCEP keep-alive timer    |
|               |                                                                                                                                                                                            |           |                                 |
...
::
	...
	dnRouter(cfg-te-pcep-pce)# no keep-alive
