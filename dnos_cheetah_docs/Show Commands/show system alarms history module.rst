show system alarms history module
---------------------------------

**Minimum user role:** viewer

To display the system alarms history, the recent cleared alarms in the system filtered by module name:



**Command syntax: show system alarms history module [module-name]** severity[severity-name] \| state[operator-state] \| all-history-records \| severity[severity-name] state[operator-state] \| severity[severity-name] all-history-records \| state[operator-state] all-history-records \| severity[severity-name] state[operator-state] all-history-records
...
::
    ...
    dnRouter# show system alarms history module isis
    ...
    dnRouter# show system alarms history module isis severity major
    ...
    dnRouter# show system alarms history module isis state ack
    ...
    dnRouter# show system alarms history module isis state closed
    ...
    dnRouter# show system alarms history module isis state closed severity major
    ...
    dnRouter# show system alarms history module isis all-history-records
