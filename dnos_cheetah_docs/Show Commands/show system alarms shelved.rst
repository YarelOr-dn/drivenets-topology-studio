show system alarms shelved
--------------------------

**Minimum user role:** viewer

To display the system alarms that are currently shelved in the system:



**Command syntax: show system alarms shelved** severity[severity-name] \| state[operator-state] \| shelve [shelve-name] \| severity[severity-name] state[operator-state] \| severity[severity-name] shelve [shelve-name] \| state[operator-state] shelve [shelve-name] \| severity[severity-name] state[operator-state] shelve [shelve-name]
...
::
    ...
    dnRouter# show system alarms shelved
    ...
    dnRouter# show system alarms shelved severity critical
    ...
    dnRouter# show system alarms shelved state ack
    ...
    dnRouter# show system alarms shelved state closed
    ...
    dnRouter# show system alarms shelved shelve s1
    ...
    dnRouter# show system alarms shelved state closed shelve s1
