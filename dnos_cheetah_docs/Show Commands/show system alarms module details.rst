show system alarms module details
---------------------------------

**Minimum user role:** viewer

To display the system alarms with additional details that are currently active in the system filtered by module name:



**Command syntax: show system alarms module [module-name] details** severity[severity-name] \| state[operator-state] \| severity[severity-name] state[operator-state]
...
::
    ...
    dnRouter# show system alarms module isis details
    ...
    dnRouter# show system alarms module isis details severity major
    ...
    dnRouter# show system alarms module isis details state ack
    ...
    dnRouter# show system alarms module isis details severity major state closed
