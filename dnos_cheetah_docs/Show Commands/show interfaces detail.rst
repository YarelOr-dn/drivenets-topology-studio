...
+---------+------------------------------------------------------------------------------------------------------------------------------------------+
| TBD     | Added VLAN list and ranges information                                                                                                   |
+---------+------------------------------------------------------------------------------------------------------------------------------------------+
| TBD     | Added indication whether IP address was obtained via DHCP                                                                                |
+---------+------------------------------------------------------------------------------------------------------------------------------------------+
| TBD     | Added a flag to mark VLAN manipulation or L2 originated VLAN tags are configured, and the L2 originated VLAN tags information in the     |
|         | detailed output                                                                                                                          |
+---------+------------------------------------------------------------------------------------------------------------------------------------------+