...
Please fix this bug!`;
        ...
        try {
            if (window.safeClipboardWrite) {
                window.safeClipboardWrite(aiPrompt).then(() => {
...
═══════════════════════════════════════════════════════════`;
        ...
        if (window.safeClipboardWrite) {
            window.safeClipboardWrite(bugReport).then(() => {
...
═══════════════════════════════════`;
        ...
        window.safeClipboardWrite(placementReport).then(() => {
...
═══════════════════════════════════`;
        ...
        // Copy to clipboard with fallback
        if (window.safeClipboardWrite) {
            window.safeClipboardWrite(formattedContent).then(() => {
    ...
    copyLastLogs() {
        ...
        // Copy to clipboard with fallback
        if (window.safeClipboardWrite) {
            window.safeClipboardWrite(fullText).then(() => {
