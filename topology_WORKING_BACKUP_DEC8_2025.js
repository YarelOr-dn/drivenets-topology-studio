...
class TopologyEditor {
    constructor(canvas) {
        ...
        // Source: /home/dn/cheetah_25_4/src/py_packages/dn_common/dn_common/consts.py
        // Format: displayName = "Unofficial (Official)"
        this.driveNetsPlatforms = {
            // CHIP (Silicon) Platforms - Verified from consts.py CHIP_TO_NCP_TYPE & NCP_CHIP_MODEL
            CHIP: {
                category: 'CHIP',
                platforms: [
                    { displayName: 'J2 (Jericho2)', official: 'J2', vendor: 'Marvell', maxSpeed: '100G', forwardingRate: '2,000,000 pps', usedIn: ['NCP-40C', 'NCP-10CD'] },
                    { displayName: 'J2C (Jericho2C)', official: 'J2C', vendor: 'Marvell', maxSpeed: '100G', forwardingRate: '2,000,000 pps', usedIn: ['NCP-64X12C-S', 'NCP-64X8C-S', 'NCP-96X6C', 'NCP-96X6C-S'] },
                    { displayName: 'J2C+ (Jericho2C+)', official: 'J2C_PLUS', vendor: 'Marvell', maxSpeed: '400G', forwardingRate: '2,650,000 pps', usedIn: ['NCP-36CD-S', 'NCP-36CD-S-SA'] },
                    { displayName: 'Q2C+ (Q-Series2C+)', official: 'Q2C_PLUS', vendor: 'Marvell', maxSpeed: '400G', forwardingRate: '2,650,000 pps', usedIn: ['NCP-40C8CD', 'NCP-40C6CD-S'] },
                    { displayName: 'J3 (Jericho3)', official: 'J3', vendor: 'Marvell', maxSpeed: '400G', forwardingRate: '3,300,000 pps', usedIn: ['Future - Not yet mapped'] },
                    { displayName: 'J3-AI (Jericho3-AI)', official: 'J3_AI', vendor: 'Marvell', maxSpeed: '800G', forwardingRate: '3,300,000 pps', usedIn: ['NCP-38E'] },
                    { displayName: 'Q3D (Q-Series3D)', official: 'Q3D', vendor: 'Marvell', maxSpeed: '800G', forwardingRate: '3,000,000 pps', usedIn: ['NCP-32E-S'] },
                    { displayName: 'CS1 (Cisco Silicon)', official: 'CS1', vendor: 'Cisco', maxSpeed: '400G', forwardingRate: 'N/A', usedIn: ['NCP-32CD'] },
                    { displayName: 'TH5 (Tomahawk5)', official: 'TOMAHAWK5', vendor: 'Broadcom', maxSpeed: '800G', forwardingRate: 'N/A', usedIn: ['NCP-64E-X'] },
                    { displayName: 'TH6 (Tomahawk6)', official: 'TOMAHAWK6', vendor: 'Broadcom', maxSpeed: '800G', forwardingRate: 'N/A', usedIn: ['NCP-64MDC-X'] }
                ]
            },
            // SA (Standalone) Platforms - Verified from consts.py NCP_TYPE, HW_MODEL_PER_MODEL, CHIP_TO_NCP_TYPE
            SA: {
                category: 'SA',
                platforms: [
                    { displayName: 'NCP-1 (NCP-40C)', official: 'NCP-40C', chip: 'J2', hwModels: ['S9700-53DX', 'AGCXD40S', 'AS7926-40XKFB'], speeds: ['100G'], interfaces: this.generateInterfaces('NCP-40C') },
                    { displayName: 'NCP-2 (NCP-10CD)', official: 'NCP-10CD', chip: 'J2', hwModels: ['S9700-23D'], speeds: ['100G'], interfaces: this.generateInterfaces('NCP-10CD') },
                    { displayName: 'NCP-3 (NCP-36CD-S)', official: 'NCP-36CD-S', chip: 'J2C+', hwModels: ['S9710-76D'], speeds: ['100G', '400G'], interfaces: this.generateInterfaces('NCP-36CD-S') },
                    { displayName: 'NCP-3-SA (NCP-36CD-S-SA)', official: 'NCP-36CD-S-SA', chip: 'J2C+', hwModels: ['S9610-36D', 'S9611-36D'], speeds: ['100G', '400G'], interfaces: this.generateInterfaces('NCP-36CD-S-SA') },
                    { displayName: 'NCP-5 (NCP-38E)', official: 'NCP-38E', chip: 'J3-AI', hwModels: ['ASA926-18XKE', 'ASA926-18XKA'], speeds: ['100G', '400G', '800G'], interfaces: this.generateInterfaces('NCP-38E') },
                    { displayName: 'NCP-6 (NCP-40C8CD)', official: 'NCP-40C8CD', chip: 'Q2C+', hwModels: ['S9610-48DX'], speeds: ['100G', '400G'], interfaces: this.generateInterfaces('NCP-40C8CD') },
                    { displayName: 'NCP-6-S (NCP-40C6CD-S)', official: 'NCP-40C6CD-S', chip: 'Q2C+', hwModels: ['S9610-46DX'], speeds: ['100G', '400G'], interfaces: this.generateInterfaces('NCP-40C6CD-S') },
                    { displayName: 'NCPL (NCP-64X12C-S)', official: 'NCP-64X12C-S', chip: 'J2C', hwModels: ['S9701-82DC'], speeds: ['1G', '10G', '25G', '100G'], interfaces: this.generateInterfaces('NCP-64X12C-S') },
                    { displayName: 'NCPL-SA (NCP-64X8C-S)', official: 'NCP-64X8C-S', chip: 'J2C', hwModels: ['S9600-72XC'], speeds: ['1G', '10G', '25G', '100G'], interfaces: this.generateInterfaces('NCP-64X8C-S') },
                    { displayName: 'NCP-9 (NCP-96X6C-S)', official: 'NCP-96X6C-S', chip: 'J2C', hwModels: ['S9601-102XC-R'], speeds: ['100G', '400G'], interfaces: this.generateInterfaces('NCP-96X6C-S') },
                    { displayName: 'NCP-10 (NCP-32E-S)', official: 'NCP-32E-S', chip: 'Q3D', hwModels: ['S9620-32E'], speeds: ['100G', '400G', '800G'], interfaces: this.generateInterfaces('NCP-32E-S') },
                    { displayName: 'Cisco (NCP-32CD)', official: 'NCP-32CD', chip: 'CS1', hwModels: ['CS1-WB2000-32FH', 'CS1-8203', 'AS9286-32D'], speeds: ['100G', '400G'], interfaces: this.generateInterfaces('NCP-32CD') },
                    { displayName: 'AI-TH5 (NCP-64E-X)', official: 'NCP-64E-X', chip: 'TH5', hwModels: ['AIS800-64O-AF', 'AS9817-64O', 'DN-2500S'], speeds: ['400G', '800G'], interfaces: this.generateInterfaces('NCP-64E-X') },
                    { displayName: 'AI-TH6 (NCP-64MDC-X)', official: 'NCP-64MDC-X', chip: 'TH6', hwModels: ['DN-2601S'], speeds: ['400G', '800G'], interfaces: this.generateInterfaces('NCP-64MDC-X') }
                ]
            },
            // CL (Cluster) Platforms - Verified from globals.py ClusterType (is_stand_alone=False, is_nc_cluster=True)
            CL: {
                category: 'CL',
                platforms: [
                    { displayName: 'CL-16 (CL-16)', official: 'CL-16', nodes: 16, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(16) },
                    { displayName: 'CL-32 (CL-32)', official: 'CL-32', nodes: 32, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(32) },
                    { displayName: 'CL-48 (CL-48)', official: 'CL-48', nodes: 48, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(48) },
                    { displayName: 'CL-49 (CL-49)', official: 'CL-49', nodes: 49, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(49) },
                    { displayName: 'CL-51 (CL-51)', official: 'CL-51', nodes: 51, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(51) },
                    { displayName: 'CL-64 (CL-64)', official: 'CL-64', nodes: 64, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(64) },
                    { displayName: 'CL-76 (CL-76)', official: 'CL-76', nodes: 76, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(76) },
                    { displayName: 'CL-86 (CL-86)', official: 'CL-86', nodes: 86, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(86) },
                    { displayName: 'CL-96 (CL-96)', official: 'CL-96', nodes: 96, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(96) },
                    { displayName: 'CL-134 (CL-134)', official: 'CL-134', nodes: 134, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(134) },
                    { displayName: 'CL-153 (CL-153)', official: 'CL-153', nodes: 153, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(153) },
                    { displayName: 'CL-192 (CL-192)', official: 'CL-192', nodes: 192, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(192) },
                    { displayName: 'CL-409 (CL-409)', official: 'CL-409', nodes: 409, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(409) },
                    { displayName: 'CL-768 (CL-768)', official: 'CL-768', nodes: 768, isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(768) },
                    { displayName: 'Hybrid (CL-HYBRID)', official: 'CL-HYBRID', nodes: 'variable', isStandalone: false, isNcCluster: true, interfaces: this.generateClusterInterfaces(16) }
                ]
            },
            // NC-AI (Network Cloud AI) Platforms - Verified from globals.py ClusterType (is_nc_ai_cluster=True)
            'NC-AI': {
                category: 'NC-AI',
                platforms: [
                    { displayName: 'AI-8K (CL-AI-8K-400G)', official: 'CL-AI-8K-400G', isJ3ai: false, fabricBreakout: false, isNcAi: true, interfaces: this.generateAIInterfaces('CL-AI-8K-400G') },
                    { displayName: 'AI-72 (CL-AI-72-400G)', official: 'CL-AI-72-400G', isJ3ai: true, fabricBreakout: false, isNcAi: true, interfaces: this.generateAIInterfaces('CL-AI-72-400G') },
                    { displayName: 'AI-216 (AI-216-800G-2)', official: 'AI-216-800G-2', isJ3ai: true, fabricBreakout: false, isNcAi: true, interfaces: this.generateAIInterfaces('AI-216-800G-2') },
                    { displayName: 'AI-768 (AI-768-400G-1)', official: 'AI-768-400G-1', isJ3ai: false, fabricBreakout: false, isNcAi: true, interfaces: this.generateAIInterfaces('AI-768-400G-1') },
                    { displayName: 'AI-72-8 (AI-72-800G-2)', official: 'AI-72-800G-2', isJ3ai: true, fabricBreakout: false, isNcAi: true, interfaces: this.generateAIInterfaces('AI-72-800G-2') },
                    { displayName: 'AI-576 (AI-576-800G-2)', official: 'AI-576-800G-2', isJ3ai: true, fabricBreakout: false, isNcAi: true, interfaces: this.generateAIInterfaces('AI-576-800G-2') },
                    { displayName: 'AI-1152 (AI-1152-800G-2)', official: 'AI-1152-800G-2', isJ3ai: true, fabricBreakout: false, isNcAi: true, interfaces: this.generateAIInterfaces('AI-1152-800G-2') },
                    { displayName: 'AI-2016 (AI-2016-800G-2)', official: 'AI-2016-800G-2', isJ3ai: true, fabricBreakout: false, isNcAi: true, interfaces: this.generateAIInterfaces('AI-2016-800G-2') },
                    { displayName: 'AI-2304 (AI-2304-800G-2)', official: 'AI-2304-800G-2', isJ3ai: true, fabricBreakout: false, isNcAi: true, interfaces: this.generateAIInterfaces('AI-2304-800G-2') },
                    { displayName: 'AI-8192 (AI-8192-400G-2)', official: 'AI-8192-400G-2', isJ3ai: true, fabricBreakout: true, isNcAi: true, interfaces: this.generateAIInterfaces('AI-8192-400G-2') }
                ]
            }
        };
        
        // ========== TRANSCEIVER DATABASE ==========
        // Transceivers mapped to interface speeds/types
        this.transceivers = {
            // 1G Transceivers (SFP form factor)
            '1G': [
                { name: 'SFP-1G-SX', type: 'SFP', speed: '1G', reach: '550m', media: 'MMF', wavelength: '850nm' },
                { name: 'SFP-1G-LX', type: 'SFP', speed: '1G', reach: '10km', media: 'SMF', wavelength: '1310nm' },
                { name: 'SFP-1G-ZX', type: 'SFP', speed: '1G', reach: '80km', media: 'SMF', wavelength: '1550nm' },
                { name: 'SFP-1G-T', type: 'SFP', speed: '1G', reach: '100m', media: 'RJ45', wavelength: 'N/A' }
            ],
            // 10G Transceivers (SFP+ form factor)
            '10G': [
                { name: 'SFP+-10G-SR', type: 'SFP+', speed: '10G', reach: '300m', media: 'MMF', wavelength: '850nm' },
                { name: 'SFP+-10G-LR', type: 'SFP+', speed: '10G', reach: '10km', media: 'SMF', wavelength: '1310nm' },
                { name: 'SFP+-10G-ER', type: 'SFP+', speed: '10G', reach: '40km', media: 'SMF', wavelength: '1550nm' },
                { name: 'SFP+-10G-ZR', type: 'SFP+', speed: '10G', reach: '80km', media: 'SMF', wavelength: '1550nm' },
                { name: 'SFP+-10G-DAC', type: 'SFP+ DAC', speed: '10G', reach: '1-7m', media: 'Copper', wavelength: 'N/A' },
                { name: 'SFP+-10G-AOC', type: 'SFP+ AOC', speed: '10G', reach: '1-100m', media: 'Active Optical', wavelength: '850nm' }
            ],
            // 25G Transceivers (SFP28 form factor)
            '25G': [
                { name: 'SFP28-25G-SR', type: 'SFP28', speed: '25G', reach: '100m', media: 'MMF', wavelength: '850nm' },
                { name: 'SFP28-25G-LR', type: 'SFP28', speed: '25G', reach: '10km', media: 'SMF', wavelength: '1310nm' },
                { name: 'SFP28-25G-DAC', type: 'SFP28 DAC', speed: '25G', reach: '1-5m', media: 'Copper', wavelength: 'N/A' },
                { name: 'SFP28-25G-AOC', type: 'SFP28 AOC', speed: '25G', reach: '1-100m', media: 'Active Optical', wavelength: '850nm' }
            ],
            // 40G Transceivers (QSFP+ form factor)
            '40G': [
                { name: 'QSFP+-40G-SR4', type: 'QSFP+', speed: '40G', reach: '150m', media: 'MMF', wavelength: '850nm' },
                { name: 'QSFP+-40G-LR4', type: 'QSFP+', speed: '40G', reach: '10km', media: 'SMF', wavelength: 'CWDM' },
                { name: 'QSFP+-40G-ER4', type: 'QSFP+', speed: '40G', reach: '40km', media: 'SMF', wavelength: 'CWDM' },
                { name: 'QSFP+-40G-DAC', type: 'QSFP+ DAC', speed: '40G', reach: '1-7m', media: 'Copper', wavelength: 'N/A' }
            ],
            // 100G Transceivers (QSFP28 form factor)
            '100G': [
                { name: 'QSFP28-100G-SR4', type: 'QSFP28', speed: '100G', reach: '100m', media: 'MMF', wavelength: '850nm' },
                { name: 'QSFP28-100G-LR4', type: 'QSFP28', speed: '100G', reach: '10km', media: 'SMF', wavelength: 'LAN-WDM' },
                { name: 'QSFP28-100G-ER4', type: 'QSFP28', speed: '100G', reach: '40km', media: 'SMF', wavelength: 'LAN-WDM' },
                { name: 'QSFP28-100G-ZR4', type: 'QSFP28', speed: '100G', reach: '80km', media: 'SMF', wavelength: 'DWDM' },
                { name: 'QSFP28-100G-CWDM4', type: 'QSFP28', speed: '100G', reach: '2km', media: 'SMF', wavelength: 'CWDM' },
                { name: 'QSFP28-100G-PSM4', type: 'QSFP28', speed: '100G', reach: '500m', media: 'SMF', wavelength: '1310nm' },
                { name: 'QSFP28-100G-DAC', type: 'QSFP28 DAC', speed: '100G', reach: '1-5m', media: 'Copper', wavelength: 'N/A' },
                { name: 'QSFP28-100G-AOC', type: 'QSFP28 AOC', speed: '100G', reach: '1-100m', media: 'Active Optical', wavelength: '850nm' }
            ],
            // 200G Transceivers (QSFP56 form factor)
            '200G': [
                { name: 'QSFP56-200G-SR4', type: 'QSFP56', speed: '200G', reach: '100m', media: 'MMF', wavelength: '850nm' },
                { name: 'QSFP56-200G-FR4', type: 'QSFP56', speed: '200G', reach: '2km', media: 'SMF', wavelength: 'CWDM' },
                { name: 'QSFP56-200G-LR4', type: 'QSFP56', speed: '200G', reach: '10km', media: 'SMF', wavelength: 'LAN-WDM' },
                { name: 'QSFP56-200G-DAC', type: 'QSFP56 DAC', speed: '200G', reach: '1-3m', media: 'Copper', wavelength: 'N/A' }
            ],
            // 400G Transceivers (QSFP-DD / OSFP form factor)
            '400G': [
                { name: 'QSFP-DD-400G-SR8', type: 'QSFP-DD', speed: '400G', reach: '100m', media: 'MMF', wavelength: '850nm' },
                { name: 'QSFP-DD-400G-DR4', type: 'QSFP-DD', speed: '400G', reach: '500m', media: 'SMF', wavelength: '1310nm' },
                { name: 'QSFP-DD-400G-FR4', type: 'QSFP-DD', speed: '400G', reach: '2km', media: 'SMF', wavelength: 'CWDM' },
                { name: 'QSFP-DD-400G-LR4', type: 'QSFP-DD', speed: '400G', reach: '10km', media: 'SMF', wavelength: 'LAN-WDM' },
                { name: 'QSFP-DD-400G-LR8', type: 'QSFP-DD', speed: '400G', reach: '10km', media: 'SMF', wavelength: 'LAN-WDM' },
                { name: 'QSFP-DD-400G-ER4', type: 'QSFP-DD', speed: '400G', reach: '40km', media: 'SMF', wavelength: 'LAN-WDM' },
                { name: 'QSFP-DD-400G-ZR', type: 'QSFP-DD', speed: '400G', reach: '120km', media: 'SMF', wavelength: 'DWDM' },
                { name: 'QSFP-DD-400G-DAC', type: 'QSFP-DD DAC', speed: '400G', reach: '1-3m', media: 'Copper', wavelength: 'N/A' },
                { name: 'OSFP-400G-SR8', type: 'OSFP', speed: '400G', reach: '100m', media: 'MMF', wavelength: '850nm' },
                { name: 'OSFP-400G-DR4', type: 'OSFP', speed: '400G', reach: '500m', media: 'SMF', wavelength: '1310nm' },
                { name: 'OSFP-400G-FR4', type: 'OSFP', speed: '400G', reach: '2km', media: 'SMF', wavelength: 'CWDM' }
            ],
            // 800G Transceivers (OSFP / QSFP-DD800 form factor)
            '800G': [
                { name: 'OSFP-800G-SR8', type: 'OSFP', speed: '800G', reach: '100m', media: 'MMF', wavelength: '850nm' },
                { name: 'OSFP-800G-DR8', type: 'OSFP', speed: '800G', reach: '500m', media: 'SMF', wavelength: '1310nm' },
                { name: 'OSFP-800G-2xFR4', type: 'OSFP', speed: '800G', reach: '2km', media: 'SMF', wavelength: 'CWDM' },
                { name: 'OSFP-800G-2xLR4', type: 'OSFP', speed: '800G', reach: '10km', media: 'SMF', wavelength: 'LAN-WDM' },
                { name: 'OSFP-800G-ZR', type: 'OSFP', speed: '800G', reach: '120km', media: 'SMF', wavelength: 'DWDM' },
                { name: 'OSFP-800G-DAC', type: 'OSFP DAC', speed: '800G', reach: '1-3m', media: 'Copper', wavelength: 'N/A' },
                { name: 'QSFP-DD800-SR8', type: 'QSFP-DD800', speed: '800G', reach: '100m', media: 'MMF', wavelength: '850nm' },
                { name: 'QSFP-DD800-DR8', type: 'QSFP-DD800', speed: '800G', reach: '500m', media: 'SMF', wavelength: '1310nm' }
            ],
            // Management/Other
            'MGMT': [
                { name: 'RJ45-1G', type: 'RJ45', speed: '1G', reach: '100m', media: 'Copper Cat6', wavelength: 'N/A' },
                { name: 'RJ45-10G', type: 'RJ45', speed: '10G', reach: '30m', media: 'Copper Cat6a', wavelength: 'N/A' }
            ]
        };
        ...
        this.interfaceToTransceiverMap = {
            ...
            'lag': '100G',      // LAG (default to 100G, depends on members)
            'loopback': null,   // Loopback - no transceiver
            'ai-eth': '800G',   // AI Ethernet (typically 800G)
            'rdma': '400G'      // RDMA interfaces
        };
    ...
    generateInterfaces(ncpType) {
        // Interface configs verified from physical_interfaces_provider.py breakout params
        // Port counts from HW model specs (e.g., S9700-53DX = ~53 ports)
        // Prefix based on chip max speed: J2=100G, J2C/J2C+=100G-400G, Q2C+=400G, J3-AI/Q3D=800G
        const interfaceConfigs = {
            'NCP-40C': { prefix: 'ge100', slots: 1, portsPerSlot: 40, note: 'J2 chip, S9700-53DX' },
            'NCP-10CD': { prefix: 'ge100', slots: 1, portsPerSlot: 10, note: 'J2 chip, S9700-23D' },
            'NCP-36CD-S': { prefix: 'ge400', slots: 1, portsPerSlot: 36, note: 'J2C+ chip, S9710-76D' },
            'NCP-36CD-S-SA': { prefix: 'ge400', slots: 1, portsPerSlot: 36, note: 'J2C+ chip, S9610/S9611-36D' },
            'NCP-38E': { prefix: 'ge800', slots: 1, portsPerSlot: 18, note: 'J3-AI chip, ASA926-18XK*' },
            'NCP-40C8CD': { prefix: 'ge100', slots: 1, portsPerSlot: 48, note: 'Q2C+ chip, S9610-48DX' },
            'NCP-40C6CD-S': { prefix: 'ge100', slots: 1, portsPerSlot: 46, note: 'Q2C+ chip, S9610-46DX' },
            'NCP-64X12C-S': { prefix: 'ge100', slots: 1, portsPerSlot: 82, note: 'J2C chip, S9701-82DC' },
            'NCP-64X8C-S': { prefix: 'ge100', slots: 1, portsPerSlot: 72, note: 'J2C chip, S9600-72XC' },
            'NCP-96X6C-S': { prefix: 'ge100', slots: 1, portsPerSlot: 102, note: 'J2C chip, S9601-102XC-R' },
            'NCP-32E-S': { prefix: 'ge800', slots: 1, portsPerSlot: 32, note: 'Q3D chip, S9620-32E' },
            'NCP-32CD': { prefix: 'ge400', slots: 1, portsPerSlot: 32, note: 'CS1 chip, CS1-*/AS9286-32D' },
            'NCP-64E-X': { prefix: 'ge800', slots: 1, portsPerSlot: 64, note: 'TH5 chip, AI/AS models' },
            'NCP-64MDC-X': { prefix: 'ge800', slots: 1, portsPerSlot: 64, note: 'TH6 chip, DN-2601S' }
        };
        
        const config = interfaceConfigs[ncpType] || { prefix: 'ge100', slots: 1, portsPerSlot: 40 };
        const interfaces = [];
        
        for (let slot = 0; slot < config.slots; slot++) {
            for (let port = 0; port < config.portsPerSlot; port++) {
                interfaces.push(`${config.prefix}-0/${slot}/${port}`);
            }
        }
        
        // Add mgmt0 and loopback for all platforms
        interfaces.push('mgmt0');
        interfaces.push('loopback-0');
        
        return interfaces;
    }
    
    // Generate interfaces for Cluster platforms - based on NCP types within cluster
    generateClusterInterfaces(nodeCount) {
        const interfaces = [];
        const portsPerNode = 8; // Simplified: 8 ports per node
        
        // Show representative ports for first few NCPs in cluster
        for (let ncpId = 0; ncpId < Math.min(nodeCount, 4); ncpId++) {
            for (let port = 0; port < portsPerNode; port++) {
                interfaces.push(`ge400-${ncpId}/0/${port}`);
            }
        }
        
        // Add LAG interfaces (common in clusters)
        for (let lag = 1; lag <= 8; lag++) {
            interfaces.push(`lag-${lag}`);
        }
    ...
    // Generate interfaces for NC-AI platforms - AI clusters use specialized interfaces
    generateAIInterfaces(aiPlatform) {
        const interfaces = [];
        const is800G = aiPlatform.includes('800G');
        const prefix = is800G ? 'ge800' : 'ge400';
        const portCount = is800G ? 32 : 64;
        
        // Standard data plane interfaces
        for (let port = 0; port < portCount; port++) {
            interfaces.push(`${prefix}-0/0/${port}`);
        }
        
        // AI-specific interfaces
        for (let aiEth = 0; aiEth < 8; aiEth++) {
            interfaces.push(`ai-eth-0/0/${aiEth}`);
        }
        
        // RDMA interfaces for AI workloads
        for (let rdma = 1; rdma <= 4; rdma++) {
            interfaces.push(`rdma-${rdma}`);
        }
            ...
            if (clickedLink && clickedLink.link.type === 'unbound') {
                ...
                if (this.debugger) {
                    ...
                    if (this.stretchingConnectionPoint) {
                        ...
                        // CRITICAL FIX: For MIDDLE links (has both mergedInto AND mergedWith),
                        // we need to determine WHICH MP based on the grabbed endpoint!
                        let partnerLinkId = null;
                        let mpNumber = 0;
                        
                        const isMiddleLink = clickedLink.link.mergedInto && clickedLink.link.mergedWith;
                        
                        if (isMiddleLink) {
                            // Middle link - determine which MP based on grabbed endpoint
                            // mergedInto connects this link to its PARENT (via this link's endpoint stored in parent.mergedWith.childConnectionEndpoint)
                            // mergedWith connects this link to its CHILD (via this link's endpoint stored in mergedWith.connectionEndpoint)
                            
                            const parentLink = this.objects.find(o => o.id === clickedLink.link.mergedInto.parentId);
                            ...
                            const childConnectsToEndpoint = clickedLink.link.mergedWith.connectionEndpoint ||
                                                           (clickedLink.link.mergedWith.parentFreeEnd === 'start' ? 'end' : 'start');
                            
                            if (this.stretchingEndpoint === parentConnectsToEndpoint) {
                                // Grabbed the endpoint connecting to PARENT → this is the MP stored in parent.mergedWith
                                partnerLinkId = clickedLink.link.mergedInto.parentId;
                                mpNumber = parentLink?.mergedWith?.mpNumber || 0;
                            } else if (this.stretchingEndpoint === childConnectsToEndpoint) {
                                // Grabbed the endpoint connecting to CHILD → this is the MP stored in this link's mergedWith
                                partnerLinkId = clickedLink.link.mergedWith.linkId;
                                mpNumber = clickedLink.link.mergedWith.mpNumber || 0;
                            }
                        } else if (clickedLink.link.mergedWith) {
                            partnerLinkId = clickedLink.link.mergedWith.linkId;
                            mpNumber = clickedLink.link.mergedWith.mpNumber || 0;
    ...
    handleMouseMove(e) {
        ...
        if (this.stretchingLink && this.stretchingEndpoint) {
            ...
            if (this.stretchingConnectionPoint) {
                ...
                const isMiddleLink = this.stretchingLink.mergedInto && this.stretchingLink.mergedWith;
                ...
                if (isMiddleLink) {
                    ...
                    const childConnectsToEndpoint = this.stretchingLink.mergedWith.connectionEndpoint ||
                        (this.stretchingLink.mergedWith.parentFreeEnd === 'start' ? 'end' : 'start');
...
Zoom: ${this.zoom.toFixed(3)}, Pan: (${this.panOffset.x.toFixed(2)}, ${this.panOffset.y.toFixed(2)})`;
        ...
        if (this.stretchingLink && this.stretchingEndpoint && this.linkStickyMode) {
            ...
            if (nearbyDevice) {
                ...
                if (endpoints.hasEndpoints) {
                    ...
                    const dev1 = this.objects.find(d => d.id === endpoints.device1);
                    const dev2 = this.objects.find(d => d.id === endpoints.device2);
                    if (dev1 && dev2) {
                        ...
                        if (this.stretchingLink.device1 === endpoints.device1) {
                            this.stretchingLink.device1Angle = baseAngle;
                        } else {
                            this.stretchingLink.device1Angle = baseAngle + Math.PI;
                        }
                        
                        if (this.stretchingLink.device2 === endpoints.device2) {
                            this.stretchingLink.device2Angle = baseAngle + Math.PI;
                        } else {
                            this.stretchingLink.device2Angle = baseAngle;
                        }
                        ...
                        const isNormalDirection = this.stretchingLink.device1 === sortedIds[0];
                        ...
                        // Update start endpoint position
                        if (this.stretchingLink.device1) {
                            const actualDev1 = this.objects.find(d => d.id === this.stretchingLink.device1);
                            if (actualDev1) {
                                const baseStartX = actualDev1.x + Math.cos(this.stretchingLink.device1Angle) * actualDev1.radius;
                                const baseStartY = actualDev1.y + Math.sin(this.stretchingLink.device1Angle) * actualDev1.radius;
                                ...
                                this.stretchingLink.start.x = actualDev1.x + Math.cos(startDirAngle) * actualDev1.radius;
                                this.stretchingLink.start.y = actualDev1.y + Math.sin(startDirAngle) * actualDev1.radius;
                            }
                        }
                        
                        // Update end endpoint position
                        if (this.stretchingLink.device2) {
                            const actualDev2 = this.objects.find(d => d.id === this.stretchingLink.device2);
                            if (actualDev2) {
                                const baseEndX = actualDev2.x + Math.cos(this.stretchingLink.device2Angle) * actualDev2.radius;
                                const baseEndY = actualDev2.y + Math.sin(this.stretchingLink.device2Angle) * actualDev2.radius;
                                ...
                                this.stretchingLink.end.x = actualDev2.x + Math.cos(endDirAngle) * actualDev2.radius;
                                this.stretchingLink.end.y = actualDev2.y + Math.sin(endDirAngle) * actualDev2.radius;
                            }
                        }
                    }
    ...
    findObjectAt(x, y) {
        ...
        for (let i = this.objects.length - 1; i >= 0; i--) {
            ...
            if (obj.type === 'unbound' || obj.type === 'link') {
                // Skip child links in BUL chains - they're handled via the chain HEAD
                // CRITICAL FIX: Only skip if NOT the head (head has no mergedInto)
                if (obj.type === 'unbound' && obj.mergedInto && !obj.mergedWith) {
                    // This is a pure TAIL link - skip it, it will be checked via head
                    continue;
                }
                if (obj.type === 'unbound' && obj.mergedInto && obj.mergedWith) {
                    // This is a MIDDLE link - skip it, it will be checked via head
                    continue;
                }
                    ...
                    if (d1 && d2) {
                        ...
                        const connectedLinks = this.objects.filter(o => {
                            ...
                            if (o.type === 'link' && o.device1 && o.device2) {
                                return (o.device1 === obj.device1 && o.device2 === obj.device2) ||
                            ...
                            if (o.type === 'unbound' && (o.mergedWith || o.mergedInto)) {
                                const oEndpoints = this.getBULEndpointDevices(o);
                                if (!oEndpoints.hasEndpoints) return false;
                                return (oEndpoints.device1 === obj.device1 && oEndpoints.device2 === obj.device2) ||
                                       (oEndpoints.device1 === obj.device2 && oEndpoints.device2 === obj.device1);
                            }
                ...
                // Also check distance to ALL links in the BUL chain (not just direct children)
                if (obj.type === 'unbound' && (obj.mergedWith || obj.mergedInto)) {
                    // Get ALL links in the chain
                    const allChainLinks = this.getAllMergedLinks(obj);
                    
                    for (const chainLink of allChainLinks) {
                        // Skip the main link (already checked above)
                        if (chainLink.id === obj.id) continue;
                        
                        if (chainLink.start && chainLink.end) {
                            let distToChainLink = Infinity;
                            
                            if (chainLink.device1 && chainLink.device2) {
                                const d1 = this.objects.find(o => o.id === chainLink.device1);
                                const d2 = this.objects.find(o => o.id === chainLink.device2);
                                if (d1 && d2) {
                                    distToChainLink = this.distanceToCurvedLine(x, y, chainLink, d1, d2);
                                } else {
                                    distToChainLink = this.distanceToLine(x, y, chainLink.start, chainLink.end);
                                }
                            } else {
                                distToChainLink = this.distanceToLine(x, y, chainLink.start, chainLink.end);
                            }
                            
                            // Use whichever is closest in the chain
        ...
        if (linkDistances.length > 0) {
            ...
            // BALANCED: Hitbox that matches visual link width for easy clicking
            // 12px screen-space = comfortable click area matching visual line thickness
    ...
    distanceToCurvedLine(px, py, link, device1, device2) {
        ...
        if (link.start && link.end) {
            ...
            // Fallback: calculate from device positions
        const offsetX = Math.cos(perpAngle) * offsetAmount;
        const offsetY = Math.sin(perpAngle) * offsetAmount;
        ...
        const endY = device2.y - Math.sin(angle) * device2.radius;
            ...
            offsetStartX = startX + offsetX;
            offsetStartY = startY + offsetY;
            offsetEndX = endX + offsetX;
            offsetEndY = endY + offsetY;
        }
    ...
    showLinkDetails(link) {
        ...
        // Initialize platform properties if they don't exist
        if (!link.device1PlatformCategory) link.device1PlatformCategory = '';
        if (!link.device1Platform) link.device1Platform = '';
        if (!link.device2PlatformCategory) link.device2PlatformCategory = '';
        if (!link.device2Platform) link.device2Platform = '';
        if (!link.device1IpType) link.device1IpType = '';
        if (!link.device1IpAddress) link.device1IpAddress = '';
        if (!link.device2IpType) link.device2IpType = '';
        if (!link.device2IpAddress) link.device2IpAddress = '';
        
        // Parse VLAN stack into outer/inner
        const parseVlanStack = (vlanStack) => {
            if (!vlanStack) return { outer: '', inner: '' };
            const parts = vlanStack.split('.');
            return { outer: parts[0] || '', inner: parts[1] || '' };
        };
        const d1Vlan = parseVlanStack(link.device1Vlan);
        const d2Vlan = parseVlanStack(link.device2Vlan);
        
        // Generate platform category options
        const categoryOptions = `
            <option value="">-- Select --</option>
            <option value="SA">SA (Standalone)</option>
            <option value="CL">CL (Cluster)</option>
            <option value="NC-AI">NC-AI</option>
        `;
        
        // Generate VLAN manipulation options - Complete DriveNets options
        // Actions: pop, pop-pop, push, push-push, swap, swap-swap, pop-swap, swap-push, preserve-swap
        const vlanManipOptions = `
            <option value="">-- None --</option>
            <optgroup label="Pop (Remove Tags)">
                <option value="pop">pop (remove outer)</option>
                <option value="pop-pop">pop-pop (remove both)</option>
            </optgroup>
            <optgroup label="Push (Add Tags)">
                <option value="push">push (add outer)</option>
                <option value="push-push">push-push (add both)</option>
            </optgroup>
            <optgroup label="Swap (Replace Tags)">
                <option value="swap">swap (replace outer)</option>
                <option value="swap-swap">swap-swap (replace both)</option>
            </optgroup>
            <optgroup label="Combined Operations">
                <option value="pop-swap">pop-swap (pop outer, swap inner→outer)</option>
                <option value="swap-push">swap-push (swap outer, push inner)</option>
                <option value="preserve-swap">preserve-swap (keep outer, swap inner)</option>
            </optgroup>
        `;
        
        // TPID options for tag protocol identifier
        const tpidOptions = `
            <option value="">Auto</option>
            <option value="0x8100">0x8100 (802.1Q)</option>
            <option value="0x88a8">0x88a8 (802.1ad Q-in-Q)</option>
            <option value="0x9100">0x9100 (Legacy Q-in-Q)</option>
            <option value="0x9200">0x9200 (Legacy Q-in-Q)</option>
        `;
        
        // Generate IP/L2 Service options
        const ipL2Options = `
            <option value="">-- Select --</option>
            <option value="L2-Service">L2-Service</option>
        ...
        tableBody.innerHTML = `
            <tr>
                <!-- Side A: Platform Category -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(192,57,43,0.1), rgba(231,76,60,0.1)); transition: all 0.3s ease;">
                    <select id="link-d1-platform-category" class="link-table-select" style="font-size: 10px; padding: 4px;" title="Select platform category">
                        ${categoryOptions}
                    </select>
                </td>
                <!-- Side A: Platform Model -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(231,76,60,0.1), rgba(192,57,43,0.05)); transition: all 0.3s ease;">
                    <select id="link-d1-platform" class="link-table-select" style="font-size: 10px; padding: 4px;" title="Select platform model" disabled>
                        <option value="">-- Select Category First --</option>
                    </select>
                </td>
                <!-- Side A: Interface -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(142,68,173,0.1), rgba(155,89,182,0.1)); transition: all 0.3s ease;">
                    <select id="link-d1-interface" class="link-table-select" style="font-size: 10px; padding: 4px;" title="Select interface" disabled>
                        <option value="${device1InterfaceName}">${device1InterfaceName || '-- Select Platform --'}</option>
                    </select>
                </td>
                <!-- Side A: Transceiver -->
                <td class="link-table-input-cell" style="transition: all 0.3s ease;">
                    <select id="link-d1-transceiver" class="link-table-select" style="font-size: 10px; padding: 4px;" title="Select transceiver" disabled>
                        <option value="">-- Select Interface First --</option>
                    </select>
                </td>
                <!-- Side A: Outer VLAN -->
                <td class="link-table-input-cell" style="background: rgba(52,73,94,0.05); transition: all 0.3s ease;">
                    <input type="text" id="link-d1-vlan-outer" value="${d1Vlan.outer}" placeholder="Outer" class="link-table-input" style="font-size: 10px; padding: 4px; text-align: center;" title="Outer VLAN tag">
                </td>
                <!-- Side A: Inner VLAN -->
                <td class="link-table-input-cell" style="background: rgba(52,73,94,0.08); transition: all 0.3s ease;">
                    <input type="text" id="link-d1-vlan-inner" value="${d1Vlan.inner}" placeholder="Inner" class="link-table-input" style="font-size: 10px; padding: 4px; text-align: center;" title="Inner VLAN tag">
                </td>
                <!-- Side A: IP/L2 Service -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(41,128,185,0.1), rgba(52,152,219,0.1)); transition: all 0.3s ease;">
                    <div style="display: flex; flex-direction: column; gap: 2px;">
                        <select id="link-d1-ip-type" class="link-table-select" style="font-size: 10px; padding: 3px;" title="Select IP/L2 Service type">
                            ${ipL2Options}
                        </select>
                        <input type="text" id="link-d1-ip-address" value="${link.device1IpAddress || ''}" placeholder="Address" class="link-table-input" style="font-size: 9px; padding: 3px; display: none;" title="IP Address">
                    </div>
                </td>
                <!-- Side A: Egress VLAN Manipulation (traffic leaving Side A) -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(22,160,133,0.1), rgba(26,188,156,0.1)); transition: all 0.3s ease;">
                    <div style="display: flex; flex-direction: column; gap: 1px;">
                        <span style="font-size: 8px; color: #16a085; text-align: center; font-weight: bold;">EGRESS</span>
                        <select id="link-d1-egress-action" class="link-table-select" style="font-size: 9px; padding: 2px;" title="Egress manipulation action">
                            ${vlanManipOptions}
                        </select>
                        <div style="display: flex; gap: 2px;">
                            <input type="text" id="link-d1-egress-outer" value="${link.device1EgressOuter || ''}" placeholder="O-Tag" class="link-table-input" style="font-size: 8px; padding: 2px; width: 45%;" title="Outer tag value">
                            <select id="link-d1-egress-outer-tpid" class="link-table-select" style="font-size: 8px; padding: 1px; width: 55%;" title="Outer TPID">
                                ${tpidOptions}
                            </select>
                        </div>
                        <div style="display: flex; gap: 2px;">
                            <input type="text" id="link-d1-egress-inner" value="${link.device1EgressInner || ''}" placeholder="I-Tag" class="link-table-input" style="font-size: 8px; padding: 2px; width: 45%;" title="Inner tag value">
                            <select id="link-d1-egress-inner-tpid" class="link-table-select" style="font-size: 8px; padding: 1px; width: 55%;" title="Inner TPID">
                                ${tpidOptions}
                            </select>
                        </div>
                    </div>
                </td>
                <!-- Side A: Ingress VLAN Manipulation (traffic entering Side A) -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(26,188,156,0.15), rgba(22,160,133,0.15)); transition: all 0.3s ease;">
                    <div style="display: flex; flex-direction: column; gap: 1px;">
                        <span style="font-size: 8px; color: #1abc9c; text-align: center; font-weight: bold;">INGRESS</span>
                        <select id="link-d1-ingress-action" class="link-table-select" style="font-size: 9px; padding: 2px;" title="Ingress manipulation action">
                            ${vlanManipOptions}
                        </select>
                        <div style="display: flex; gap: 2px;">
                            <input type="text" id="link-d1-ingress-outer" value="${link.device1IngressOuter || ''}" placeholder="O-Tag" class="link-table-input" style="font-size: 8px; padding: 2px; width: 45%;" title="Outer tag value">
                            <select id="link-d1-ingress-outer-tpid" class="link-table-select" style="font-size: 8px; padding: 1px; width: 55%;" title="Outer TPID">
                                ${tpidOptions}
                            </select>
                        </div>
                        <div style="display: flex; gap: 2px;">
                            <input type="text" id="link-d1-ingress-inner" value="${link.device1IngressInner || ''}" placeholder="I-Tag" class="link-table-input" style="font-size: 8px; padding: 2px; width: 45%;" title="Inner tag value">
                            <select id="link-d1-ingress-inner-tpid" class="link-table-select" style="font-size: 8px; padding: 1px; width: 55%;" title="Inner TPID">
                                ${tpidOptions}
                            </select>
                        </div>
                    </div>
                </td>
                <!-- DNaaS Display (Ingress side A → Egress side B) -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(230,126,34,0.15), rgba(243,156,18,0.15)); transition: all 0.3s ease;">
                    <div style="display: flex; flex-direction: column; gap: 2px; align-items: center;">
                        <span style="font-size: 7px; color: #d35400; font-weight: bold;">DNaaS</span>
                        <input type="text" id="link-dnaas-vlan-ingress" value="" placeholder="(auto)" class="link-table-input" style="font-size: 9px; padding: 3px; text-align: center; font-weight: bold; color: #d35400; background: rgba(230,126,34,0.1);" readonly title="Auto-calculated DNaaS VLAN">
                    </div>
                </td>
                <!-- Center Connector -->
                <td class="link-table-connector" style="font-size: 18px; font-weight: bold; color: #3498db;">↔</td>
                <!-- DNaaS Display (Egress side A ← Ingress side B) -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(243,156,18,0.15), rgba(230,126,34,0.15)); transition: all 0.3s ease;">
                    <div style="display: flex; flex-direction: column; gap: 2px; align-items: center;">
                        <span style="font-size: 7px; color: #d35400; font-weight: bold;">DNaaS</span>
                        <input type="text" id="link-dnaas-vlan-egress" value="" placeholder="(auto)" class="link-table-input" style="font-size: 9px; padding: 3px; text-align: center; font-weight: bold; color: #d35400; background: rgba(230,126,34,0.1);" readonly title="Auto-calculated DNaaS VLAN">
                    </div>
                </td>
                <!-- Side B: Ingress VLAN Manipulation (traffic entering Side B) -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(22,160,133,0.15), rgba(26,188,156,0.15)); transition: all 0.3s ease;">
                    <div style="display: flex; flex-direction: column; gap: 1px;">
                        <span style="font-size: 8px; color: #1abc9c; text-align: center; font-weight: bold;">INGRESS</span>
                        <select id="link-d2-ingress-action" class="link-table-select" style="font-size: 9px; padding: 2px;" title="Ingress manipulation action">
                            ${vlanManipOptions}
                        </select>
                        <div style="display: flex; gap: 2px;">
                            <input type="text" id="link-d2-ingress-outer" value="${link.device2IngressOuter || ''}" placeholder="O-Tag" class="link-table-input" style="font-size: 8px; padding: 2px; width: 45%;" title="Outer tag value">
                            <select id="link-d2-ingress-outer-tpid" class="link-table-select" style="font-size: 8px; padding: 1px; width: 55%;" title="Outer TPID">
                                ${tpidOptions}
                            </select>
                        </div>
                        <div style="display: flex; gap: 2px;">
                            <input type="text" id="link-d2-ingress-inner" value="${link.device2IngressInner || ''}" placeholder="I-Tag" class="link-table-input" style="font-size: 8px; padding: 2px; width: 45%;" title="Inner tag value">
                            <select id="link-d2-ingress-inner-tpid" class="link-table-select" style="font-size: 8px; padding: 1px; width: 55%;" title="Inner TPID">
                                ${tpidOptions}
                            </select>
                        </div>
                    </div>
                </td>
                <!-- Side B: Egress VLAN Manipulation (traffic leaving Side B) -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(26,188,156,0.1), rgba(22,160,133,0.1)); transition: all 0.3s ease;">
                    <div style="display: flex; flex-direction: column; gap: 1px;">
                        <span style="font-size: 8px; color: #16a085; text-align: center; font-weight: bold;">EGRESS</span>
                        <select id="link-d2-egress-action" class="link-table-select" style="font-size: 9px; padding: 2px;" title="Egress manipulation action">
                            ${vlanManipOptions}
                        </select>
                        <div style="display: flex; gap: 2px;">
                            <input type="text" id="link-d2-egress-outer" value="${link.device2EgressOuter || ''}" placeholder="O-Tag" class="link-table-input" style="font-size: 8px; padding: 2px; width: 45%;" title="Outer tag value">
                            <select id="link-d2-egress-outer-tpid" class="link-table-select" style="font-size: 8px; padding: 1px; width: 55%;" title="Outer TPID">
                                ${tpidOptions}
                            </select>
                        </div>
                        <div style="display: flex; gap: 2px;">
                            <input type="text" id="link-d2-egress-inner" value="${link.device2EgressInner || ''}" placeholder="I-Tag" class="link-table-input" style="font-size: 8px; padding: 2px; width: 45%;" title="Inner tag value">
                            <select id="link-d2-egress-inner-tpid" class="link-table-select" style="font-size: 8px; padding: 1px; width: 55%;" title="Inner TPID">
                                ${tpidOptions}
                            </select>
                        </div>
                    </div>
                </td>
                <!-- Side B: IP/L2 Service -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(52,152,219,0.1), rgba(41,128,185,0.1)); transition: all 0.3s ease;">
                    <div style="display: flex; flex-direction: column; gap: 2px;">
                        <select id="link-d2-ip-type" class="link-table-select" style="font-size: 10px; padding: 3px;" title="Select IP/L2 Service type">
                            ${ipL2Options}
                    </select>
                        <input type="text" id="link-d2-ip-address" value="${link.device2IpAddress || ''}" placeholder="Address" class="link-table-input" style="font-size: 9px; padding: 3px; display: none;" title="IP Address">
                    </div>
                </td>
                <!-- Side B: Inner VLAN -->
                <td class="link-table-input-cell" style="background: rgba(52,73,94,0.08); transition: all 0.3s ease;">
                    <input type="text" id="link-d2-vlan-inner" value="${d2Vlan.inner}" placeholder="Inner" class="link-table-input" style="font-size: 10px; padding: 4px; text-align: center;" title="Inner VLAN tag">
                </td>
                <!-- Side B: Outer VLAN -->
                <td class="link-table-input-cell" style="background: rgba(52,73,94,0.05); transition: all 0.3s ease;">
                    <input type="text" id="link-d2-vlan-outer" value="${d2Vlan.outer}" placeholder="Outer" class="link-table-input" style="font-size: 10px; padding: 4px; text-align: center;" title="Outer VLAN tag">
                </td>
                <!-- Side B: Transceiver -->
                <td class="link-table-input-cell" style="transition: all 0.3s ease;">
                    <select id="link-d2-transceiver" class="link-table-select" style="font-size: 10px; padding: 4px;" title="Select transceiver" disabled>
                        <option value="">-- Select Interface First --</option>
                    </select>
                </td>
                <!-- Side B: Interface -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(155,89,182,0.1), rgba(142,68,173,0.1)); transition: all 0.3s ease;">
                    <select id="link-d2-interface" class="link-table-select" style="font-size: 10px; padding: 4px;" title="Select interface" disabled>
                        <option value="${device2InterfaceName}">${device2InterfaceName || '-- Select Platform --'}</option>
                    </select>
                </td>
                <!-- Side B: Platform Model -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(192,57,43,0.05), rgba(231,76,60,0.1)); transition: all 0.3s ease;">
                    <select id="link-d2-platform" class="link-table-select" style="font-size: 10px; padding: 4px;" title="Select platform model" disabled>
                        <option value="">-- Select Category First --</option>
                    </select>
                </td>
                <!-- Side B: Platform Category -->
                <td class="link-table-input-cell" style="background: linear-gradient(135deg, rgba(231,76,60,0.1), rgba(192,57,43,0.1)); transition: all 0.3s ease;">
                    <select id="link-d2-platform-category" class="link-table-select" style="font-size: 10px; padding: 4px;" title="Select platform category">
                        ${categoryOptions}
                    </select>
                </td>
            </tr>
            <tr class="link-info-row">
                <td colspan="19" class="link-info-cell">
        ...
        // Set selected values and setup event listeners after modal is displayed
        setTimeout(() => {
            const d1TransceiverSelect = document.getElementById('link-d1-transceiver');
            const d2TransceiverSelect = document.getElementById('link-d2-transceiver');
            ...
            const d1InterfaceSelect = document.getElementById('link-d1-interface');
            const d2InterfaceSelect = document.getElementById('link-d2-interface');
            
            // Populate transceivers if interface is already selected
            if (d1InterfaceSelect && link.device1Interface) {
                this.populateTransceiverDropdown('d1', link.device1Interface);
            }
            if (d2InterfaceSelect && link.device2Interface) {
                this.populateTransceiverDropdown('d2', link.device2Interface);
            }
            
            // Set transceiver values (after populating the dropdown)
            if (d1TransceiverSelect && link.device1Transceiver) {
                d1TransceiverSelect.value = link.device1Transceiver;
            }
            if (d2TransceiverSelect && link.device2Transceiver) {
                d2TransceiverSelect.value = link.device2Transceiver;
            }
            ...
            // Setup IP/L2 type dropdowns
            const d1IpTypeSelect = document.getElementById('link-d1-ip-type');
            const d2IpTypeSelect = document.getElementById('link-d2-ip-type');
            const d1IpAddressInput = document.getElementById('link-d1-ip-address');
            const d2IpAddressInput = document.getElementById('link-d2-ip-address');
            
            if (d1IpTypeSelect && link.device1IpType) {
                d1IpTypeSelect.value = link.device1IpType;
                if (link.device1IpType === 'IPv4' || link.device1IpType === 'IPv6') {
                    d1IpAddressInput.style.display = 'block';
                    d1IpAddressInput.placeholder = link.device1IpType === 'IPv4' ? '192.168.1.1/24' : '2001:db8::1/64';
                }
            }
            if (d2IpTypeSelect && link.device2IpType) {
                d2IpTypeSelect.value = link.device2IpType;
                if (link.device2IpType === 'IPv4' || link.device2IpType === 'IPv6') {
                    d2IpAddressInput.style.display = 'block';
                    d2IpAddressInput.placeholder = link.device2IpType === 'IPv4' ? '192.168.1.1/24' : '2001:db8::1/64';
                }
            }
            
            // Add IP/L2 type change listeners
            if (d1IpTypeSelect) {
                d1IpTypeSelect.addEventListener('change', () => {
                    const ipType = d1IpTypeSelect.value;
                    if (ipType === 'IPv4' || ipType === 'IPv6') {
                        d1IpAddressInput.style.display = 'block';
                        d1IpAddressInput.placeholder = ipType === 'IPv4' ? '192.168.1.1/24' : '2001:db8::1/64';
                    } else {
                        d1IpAddressInput.style.display = 'none';
                        d1IpAddressInput.value = '';
                    }
                });
            }
            if (d2IpTypeSelect) {
                d2IpTypeSelect.addEventListener('change', () => {
                    const ipType = d2IpTypeSelect.value;
                    if (ipType === 'IPv4' || ipType === 'IPv6') {
                        d2IpAddressInput.style.display = 'block';
                        d2IpAddressInput.placeholder = ipType === 'IPv4' ? '192.168.1.1/24' : '2001:db8::1/64';
                    } else {
                        d2IpAddressInput.style.display = 'none';
                        d2IpAddressInput.value = '';
                    }
                });
            }
            
            // Setup platform cascading dropdowns
            this.setupPlatformCascading('d1', link);
            this.setupPlatformCascading('d2', link);
    ...
    setupPlatformCascading(side, link) {
        ...
        if (link[categoryProp]) {
            ...
            this.populatePlatformDropdown(side, link[categoryProp]);
            
            if (link[platformProp]) {
                platformSelect.value = link[platformProp];
                this.populateInterfaceDropdown(side, link[platformProp]);
                ...
                setTimeout(() => {
                    ...
                    if (currentInterfaceSelect && link[interfaceProp]) {
                        ...
                        // Trigger transceiver population
                        this.populateTransceiverDropdown(side, link[interfaceProp]);
                    }
                }, 20);
            }
        }
        ...
        categorySelect.addEventListener('change', () => {
            ...
            if (category) {
                this.populatePlatformDropdown(side, category);
            } else {
        ...
        platformSelect.addEventListener('change', () => {
            ...
            if (platform) {
                this.populateInterfaceDropdown(side, platform);
            } else {
                resetInterface();
            }
            resetTransceiver();
        ...
        interfaceSelect.addEventListener('change', () => {
            ...
            this.populateTransceiverDropdown(side, iface);
        });
    }
    ...
    populateInterfaceDropdown(side, platformOfficial) {
        ...
        const platform = this.getPlatformByOfficial(platformOfficial);
        ...
        interfaces.forEach(iface => {
            // Extract prefix (e.g., 'ge100', 'lag', 'mgmt', 'loopback')
        ...
        sortedPrefixes.forEach(prefix => {
            ...
            // Only show first 10 per group to avoid huge lists
    ...
    populateTransceiverDropdown(side, interfaceName) {
        ...
        if (!interfaceName) {
            // No interface selected - disable transceiver dropdown
            transceiverSelect.innerHTML = '<option value="">-- Select Interface First --</option>';
            transceiverSelect.disabled = true;
            return;
        }
        ...
        if (transceivers.length === 0) {
            // Interface doesn't need transceiver (e.g., loopback, lag)
            transceiverSelect.innerHTML = '<option value="">-- N/A (No Optics) --</option>';
            transceiverSelect.disabled = true;
            return;
        }
        
        // Build options with grouping by form factor
        let optionsHtml = '<option value="">-- Select Transceiver --</option>';
        
        // Group transceivers by form factor type
        const grouped = {};
        transceivers.forEach(t => {
            const formFactor = t.type.split(' ')[0]; // Get base form factor (QSFP-DD, OSFP, etc.)
    ...
    saveLinkDetails() {
        ...
        // Get platform values
        const d1PlatformCategory = document.getElementById('link-d1-platform-category')?.value.trim() || '';
        const d1Platform = document.getElementById('link-d1-platform')?.value.trim() || '';
        const d1Interface = document.getElementById('link-d1-interface')?.value.trim() || '';
        const d2PlatformCategory = document.getElementById('link-d2-platform-category')?.value.trim() || '';
        const d2Platform = document.getElementById('link-d2-platform')?.value.trim() || '';
        const d2Interface = document.getElementById('link-d2-interface')?.value.trim() || '';
        
        // Get VLAN values (combine outer + inner)
        ...
        const d1Vlan = d1VlanInner ? `${d1VlanOuter}.${d1VlanInner}` : d1VlanOuter;
        const d2Vlan = d2VlanInner ? `${d2VlanOuter}.${d2VlanInner}` : d2VlanOuter;
        
        // Get transceiver and VLAN manipulation values
        ...
        // Get VLAN manipulation values - Egress (Side A)
        const d1EgressAction = document.getElementById('link-d1-egress-action')?.value.trim() || '';
        const d1EgressOuter = document.getElementById('link-d1-egress-outer')?.value.trim() || '';
        const d1EgressOuterTpid = document.getElementById('link-d1-egress-outer-tpid')?.value.trim() || '';
        const d1EgressInner = document.getElementById('link-d1-egress-inner')?.value.trim() || '';
        const d1EgressInnerTpid = document.getElementById('link-d1-egress-inner-tpid')?.value.trim() || '';
        
        // Get VLAN manipulation values - Ingress (Side A)
        const d1IngressAction = document.getElementById('link-d1-ingress-action')?.value.trim() || '';
        const d1IngressOuter = document.getElementById('link-d1-ingress-outer')?.value.trim() || '';
        const d1IngressOuterTpid = document.getElementById('link-d1-ingress-outer-tpid')?.value.trim() || '';
        const d1IngressInner = document.getElementById('link-d1-ingress-inner')?.value.trim() || '';
        const d1IngressInnerTpid = document.getElementById('link-d1-ingress-inner-tpid')?.value.trim() || '';
        
        // Get VLAN manipulation values - Ingress (Side B)
        const d2IngressAction = document.getElementById('link-d2-ingress-action')?.value.trim() || '';
        const d2IngressOuter = document.getElementById('link-d2-ingress-outer')?.value.trim() || '';
        const d2IngressOuterTpid = document.getElementById('link-d2-ingress-outer-tpid')?.value.trim() || '';
        const d2IngressInner = document.getElementById('link-d2-ingress-inner')?.value.trim() || '';
        const d2IngressInnerTpid = document.getElementById('link-d2-ingress-inner-tpid')?.value.trim() || '';
        
        // Get VLAN manipulation values - Egress (Side B)
        const d2EgressAction = document.getElementById('link-d2-egress-action')?.value.trim() || '';
        const d2EgressOuter = document.getElementById('link-d2-egress-outer')?.value.trim() || '';
        const d2EgressOuterTpid = document.getElementById('link-d2-egress-outer-tpid')?.value.trim() || '';
        const d2EgressInner = document.getElementById('link-d2-egress-inner')?.value.trim() || '';
        const d2EgressInnerTpid = document.getElementById('link-d2-egress-inner-tpid')?.value.trim() || '';
        
        // Get IP/L2 Service values
        const d1IpType = document.getElementById('link-d1-ip-type')?.value.trim() || '';
        const d1IpAddress = document.getElementById('link-d1-ip-address')?.value.trim() || '';
        const d2IpType = document.getElementById('link-d2-ip-type')?.value.trim() || '';
        const d2IpAddress = document.getElementById('link-d2-ip-address')?.value.trim() || '';
        
        // Update link properties - Platform
        this.editingLink.device1PlatformCategory = d1PlatformCategory;
        this.editingLink.device1Platform = d1Platform;
        this.editingLink.device1Interface = d1Interface;
        this.editingLink.device2PlatformCategory = d2PlatformCategory;
        this.editingLink.device2Platform = d2Platform;
        this.editingLink.device2Interface = d2Interface;
        
        // Update link properties - VLAN
        this.editingLink.device1Vlan = d1Vlan;
        this.editingLink.device2Vlan = d2Vlan;
        
        // Update link properties - Transceiver
        this.editingLink.device1Transceiver = d1Transceiver;
        this.editingLink.device2Transceiver = d2Transceiver;
        
        // Update link properties - VLAN Manipulation (Side A Egress)
        this.editingLink.device1EgressAction = d1EgressAction;
        this.editingLink.device1EgressOuter = d1EgressOuter;
        this.editingLink.device1EgressOuterTpid = d1EgressOuterTpid;
        this.editingLink.device1EgressInner = d1EgressInner;
        this.editingLink.device1EgressInnerTpid = d1EgressInnerTpid;
        
        // Update link properties - VLAN Manipulation (Side A Ingress)
        this.editingLink.device1IngressAction = d1IngressAction;
        this.editingLink.device1IngressOuter = d1IngressOuter;
        this.editingLink.device1IngressOuterTpid = d1IngressOuterTpid;
        this.editingLink.device1IngressInner = d1IngressInner;
        this.editingLink.device1IngressInnerTpid = d1IngressInnerTpid;
        
        // Update link properties - VLAN Manipulation (Side B Ingress)
        this.editingLink.device2IngressAction = d2IngressAction;
        this.editingLink.device2IngressOuter = d2IngressOuter;
        this.editingLink.device2IngressOuterTpid = d2IngressOuterTpid;
        this.editingLink.device2IngressInner = d2IngressInner;
        this.editingLink.device2IngressInnerTpid = d2IngressInnerTpid;
        
        // Update link properties - VLAN Manipulation (Side B Egress)
        this.editingLink.device2EgressAction = d2EgressAction;
        this.editingLink.device2EgressOuter = d2EgressOuter;
        this.editingLink.device2EgressOuterTpid = d2EgressOuterTpid;
        this.editingLink.device2EgressInner = d2EgressInner;
        this.editingLink.device2EgressInnerTpid = d2EgressInnerTpid;
        
        // Update link properties - IP/L2 Service
        this.editingLink.device1IpType = d1IpType;
        this.editingLink.device1IpAddress = d1IpAddress;
        this.editingLink.device2IpType = d2IpType;
        this.editingLink.device2IpAddress = d2IpAddress;
        
        this.draw();
        
        // Show save confirmation with smooth animation
        const saveBtn = document.getElementById('btn-save-link-details');
        if (saveBtn) {
    ...
    setupVlanCalculationListeners() {
        // Get all input fields - using new outer/inner VLAN fields
        ...
        if (d1VlanOuterInput) d1VlanOuterInput.addEventListener('input', updateFn);
        if (d1VlanInnerInput) d1VlanInnerInput.addEventListener('input', updateFn);
    ...
    updateDnaasVlanFields() {
        // Get input values - using new outer/inner VLAN fields
        const d1VlanOuterInput = document.getElementById('link-d1-vlan-outer');
        const d1VlanInnerInput = document.getElementById('link-d1-vlan-inner');
        const d1ManipSelect = document.getElementById('link-d1-vlan-manipulation');
        const d1ManipValueInput = document.getElementById('link-d1-vlan-manip-value');
        ...
        if (!d1VlanOuterInput || !ingressField || !egressField) return;
        
        // Get Device 1 VLAN values from outer/inner fields
        let d1Outer = d1VlanOuterInput.value.trim() || null;
        let d1Inner = d1VlanInnerInput ? d1VlanInnerInput.value.trim() || null : null;
    ...
    findUnboundLinkEndpoint(x, y) {
        ...
        for (let i = this.objects.length - 1; i >= 0; i--) {
            const obj = this.objects[i];
            if (obj.type === 'unbound') {
                // ENHANCED: Larger hitbox for MPs too, but still lower priority
            ...
            if (obj.type === 'unbound' && (obj.device1 || obj.device2)) {
                ...
                if (isSUL && hasBothDevices) {
                    ...
                    if (device1 && device2) {
                        ...
                        // Calculate base touch points (centered line)
                        ...
                        // Final touch points on device edges - EXACTLY like drawLink()
                        obj.start = { 
                            x: device1.x + Math.cos(startDirAngle) * device1.radius, 
                            y: device1.y + Math.sin(startDirAngle) * device1.radius 
                        };
                        obj.end = { 
                            x: device2.x + Math.cos(endDirAngle) * device2.radius, 
                            y: device2.y + Math.sin(endDirAngle) * device2.radius 
                        };
                    }
    ...
    drawUnboundLink(link) {
        ...
        if (curveEnabled) {
            ...
            if (obstacles.length > 0) {
                // Guitar string curve around obstacles - EXACTLY like drawLink()
                ...
                obstacles.forEach((obstacleInfo) => {
                    ...
                    const repelDirX = dx / distToMid;
                    const repelDirY = dy / distToMid;
                    const k = minClearance * minClearance * this.magneticFieldStrength * 2; // Match QL strength
                    const repulsionStrength = k / Math.pow(distToMid, 0.8); // Match QL exponent
                    totalRepulsionX += repelDirX * repulsionStrength;
                    totalRepulsionY += repelDirY * repulsionStrength;
                    closestObstacleRadius = Math.max(closestObstacleRadius, obstacle.radius);
                });
                ...
                // Curvier control points - EXACTLY like drawLink()
